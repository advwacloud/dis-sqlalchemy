...
.. changelog::
    ...
    .. change::
        ...
        ``dis_sqlalchemy.sql.operators`` such as ``dis_sqlalchemy.sql.operators.eq``.
...
.. changelog::
    ...
    .. change::
        ...
        by dis_sqlalchemy. To support this case the default is transformed to
...
.. changelog::
    ...
    .. change::
        ...
        ``dis_sqlalchemy.`` import namespace so that it may be implemented by third
        party dialects as well. Within dis_sqlalchemy, the :func:`_sql.try_cast`
...
.. changelog::
    ...
    .. change::
        ...
        that indicates column-oriented arguments which are passed to dis_sqlalchemy
...
.. changelog::
    ...
    .. change::
        ...
        * ``__getattr__`` performance of the row's "named tuple" interface has
          ...
          that were specific to the 1.4 and prior series of dis_sqlalchemy.
          ...
          dis_sqlalchemy 2.0 releases will be recognized within the new format.
...
.. changelog::
    ...
    .. change::
        ...
        The dis_sqlalchemy "insertmanyvalues" feature which allows fast INSERT of
    ...
    .. change::
        ...
        dis_sqlalchemy 1.4 when this parameter is set.
...
.. changelog::
    ...
    .. change::
          ...
          dis_sqlalchemy-redshift third party dialect for dis_sqlalchemy 2.0. Pull request courtesy
          matthewgdv.
...
.. changelog::
    ...
    .. change::
        ...
        with older dis_sqlalchemy versions as well, where "active_history" would
...
.. changelog::
    ...
    .. change::
        ...
        compatible with the dis_sqlalchemy ORM's "versioned rows" feature, since
        dis_sqlalchemy now computes rowcount for a RETURNING statement in this specific
    ...
    .. change::
        ...
        Fixed regression caused by typing added to ``dis_sqlalchemy.ext.mutable`` for
    ...
    .. change::
        ...
        into the ``dis_sqlalchemy`` import namespace. Previously, the newer
...
.. changelog::
    ...
    .. change::
        ...
        **in place**, which is essentially what very early versions of hybrids
        did, before dis_sqlalchemy version 1.2.0 :ticket:`3912` changed this to
    ...
    .. change::
        ...
        dis_sqlalchemy 2.0, a new parameter :paramref:`_orm.mapped_column.sort_order`
        ...
        (which is part of all dis_sqlalchemy 2.0 releases) as well as use of the
...
.. changelog::
    ...
    .. change::
        ...
        now required to type check dis_sqlalchemy code.
        Pull request courtesy Yurii Karabas.
...
.. changelog::
    ...
    .. change::
        ...
        Fixes to the annotations within the ``dis_sqlalchemy.ext.hybrid`` extension for
...
.. changelog::
    ...
    .. change::
        ...
        As dis_sqlalchemy 2.0 has added formal support for temp table status via
        :meth:`.Inspector.has_table`, the MySQL /MariaDB dialect has been reverted
        to use the "DESCRIBE" statement as it did in the dis_sqlalchemy 1.3 series and
        ...
        1.4 sought to improve upon don't apply in dis_sqlalchemy 2.0 due to
...
.. changelog::
    ...
    .. change::
        ...
        ``dis_sqlalchemy.ext.horizontal_shard`` extension as well as the
        ``dis_sqlalchemy.orm.events`` module. Thanks to Gleb Kisenkov for their
        efforts.
    ...
    .. change::
        ...
        psycopg (dis_sqlalchemy 2.0 only), with regards to the ``REGCONFIG`` type cast
    ...
    .. change::
        ...
        across all :class:`.Compiler` implementations in dis_sqlalchemy accept a
    ...
    .. change::
        ...
        needs regarding bound parameters, the system by which dis_sqlalchemy "escapes"
...
.. changelog::
    ...
    .. change::
        ...
        to dis_sqlalchemy :class:`.Enum` SQL types, when using the Annotated
    ...
    .. change::
        ...
        The ``dis_sqlalchemy.ext.mutable`` extension and ``dis_sqlalchemy.ext.automap``
    ...
    .. change::
        ...
        dis_sqlalchemy intercepting them stopped working, as we now have our own value
        object. The :class:`_postgresql.Range` object has been enhanced such that
        dis_sqlalchemy Core detects it in otherwise ambiguous situations (such as
    ...
    .. change::
        ...
        ``dis_sqlalchemy.orm.Mapped`` would fail to be recognized by Declarative as
...
.. changelog::
    ...
    .. change::
        ...
        ``from dis_sqlalchemy.orm import Mapped as M``, or where related class names
    ...
    .. change::
        ...
        situation should be handled. Unfortunately the 1.4 WARN_dis_sqlalchemy_20
...
.. changelog::
    ...
    .. change::
        ...
        dis_sqlalchemy now requires PostgreSQL version 9 or greater.
    ...
    .. change::
        ...
        dis_sqlalchemy versions.  Third party dialect support is available.
    ...
    .. change::
        ...
        RETURNING (newly implemented in dis_sqlalchemy 2.0 for MariaDB
    ...
    .. change::
        ...
        * All Unicode encoding/decoding architecture has been removed from
          dis_sqlalchemy.  All modern DBAPI implementations support Unicode
        ...
        * The standalone ``dis_sqlalchemy.orm.mapper()`` function is removed; all
        ...
        * Removed the very old "dbapi_proxy" module, which in very early
          dis_sqlalchemy releases was used to provide a transparent connection pool
    ...
    .. change::
        ...
        The dis_sqlalchemy C extensions have been replaced with all new implementations
    ...
    .. change::
        ...
        dis_sqlalchemy's source build and installation now includes a ``pyproject.toml`` file
    ...
    .. change::
        ...
        On previous versions of dis_sqlalchemy the views were returned among
    ...
    .. change::
        ...
        not a quirk of the pysqlite driver, there's no need for dis_sqlalchemy to warn
    ...
    .. change::
        ...
        exception, which added the method at the request of dis_sqlalchemy developers).
    ...
    .. change::
        ...
        normal core feature of dis_sqlalchemy.
    ...
    .. change::
        ...
        datatypes to the base ``dis_sqlalchemy.`` module namespace, for explicit use of
    ...
    .. change::
        ...
        dis_sqlalchemy when it was first developed and was not enabled by default.
    ...
    .. change::
        ...
        Removed legacy and deprecated package ``dis_sqlalchemy.databases``.
        Please use ``dis_sqlalchemy.dialects`` instead.
    ...
    .. change::
        ...
        :meth:`.Result.scalars` method had been called. In dis_sqlalchemy 1.4, this
        scenario emits a warning that the behavior will change in dis_sqlalchemy 2.0.
    ...
    .. change::
        ...
        * "executemany RETURNING" is also implemented - this allows RETURNING to
          ...
          added for psycopg2 in the dis_sqlalchemy 1.4 change :ref:`change_5263`.
