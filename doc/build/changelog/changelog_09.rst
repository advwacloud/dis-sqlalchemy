...
.. _unreleased_changelog::
    ...
    .. change::
        ...
        up dis_sqlalchemy's version detection under Python 3 and inadvertently
...
.. changelog::
    ...
    .. change::
        ...
        operation with unicode parameters.  dis_sqlalchemy now passes both
    ...
    .. change::
        ...
        symbol was removed from the ``dis_sqlalchemy.ext.declarative``
        namespace.
...
.. changelog::
    ...
    .. change::
        ...
        is in play; DBAPIs and/or dis_sqlalchemy dialects such as psycopg2,
    ...
    .. change::
        ...
        of JSONB data so that dis_sqlalchemy's converters must be disabled;
    ...
    .. change::
        ...
        .. seealso::
            ...
            :mod:`~dis_sqlalchemy.dialects.sqlite.pysqlcipher`
...
.. changelog::
    ...
    .. change::
        ...
        using the closest available subclass in ``dis_sqlalchemy.exc``, in the
        case of TransactionRollbackError, ``dis_sqlalchemy.exc.OperationalError``.
...
.. changelog::
    ...
    .. change::
        ...
        .. note::
            ...
            will be in version 1.0 of dis_sqlalchemy.
    ...
    .. change::
        ...
        Restored the import for :class:`.Function` to the ``dis_sqlalchemy.sql.expression``
...
.. changelog::
    ...
    .. change::
        ...
        "supports unicode statements" flag is now False, so that dis_sqlalchemy
    ...
    .. change::
        ...
        by dis_sqlalchemy has been split out so that it works under pytest as
        ...
        on dis_sqlalchemy's test suite as a basis; see the file README.dialects.rst
        for background on building out from dis_sqlalchemy's test platform.
...
.. changelog::
    ...
    .. change::
        ...
        into the names used by standard functions in :mod:`dis_sqlalchemy.sql.functions`,
    ...
    .. change::
        ...
        As dis_sqlalchemy cannot easily select for this style of type handler on a
        per-column basis, the handler was assembled unconditionally thereby
        adding the overhead to all string access.

        So this logic has been replaced with dis_sqlalchemy's own unicode
        conversion system, which now
        only takes effect in Py2K for columns that are requested as unicode.
        When C extensions are used, dis_sqlalchemy's system appears to be 2-3x faster than
        cx_Oracle's.  Additionally, dis_sqlalchemy's unicode conversion has been
    ...
    .. change::
        ...
        Restored :class:`dis_sqlalchemy.schema.SchemaVisitor` to the ``.schema``
...
.. changelog::
    ...
    .. change::
        ...
        A new, **experimental** extension :mod:`dis_sqlalchemy.ext.automap` is added.
...
.. changelog::
    ...
    .. change::
        ...
        of the ORM modules.  In particular ``dis_sqlalchemy.sql`` has been broken
        out into several more modules than before so that the very large size
        of ``dis_sqlalchemy.sql.expression`` is now pared down.   The effort
        has focused on a large reduction in import cycles.   Additionally,
        the system of API functions in ``dis_sqlalchemy.sql.expression`` and
        ``dis_sqlalchemy.orm`` has been reorganized to eliminate redundancy
    ...
    .. change::
        ...
        A :func:`~dis_sqlalchemy.sql.expression.label` construct will now render as its name alone
