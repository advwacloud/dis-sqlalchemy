...
.. changelog::
    ...
    .. change::
      ...
      when the import of dis_sqlalchemy or dis_sqlalchemy.orm
...
.. changelog::
    ...
    .. change::
      ...
      with declarative is dis_sqlalchemy.ext.declarative.declared_attr.
    ...
    .. change::
      ...
      the Nosedis_sqlalchemyPlugin has been moved to a
      new package "dis_sqlalchemy_nose" which installs
      along with "dis_sqlalchemy".  This so that the "nosetests"
      script works as always but also allows the
      --with-coverage option to turn on coverage before
      dis_sqlalchemy modules are imported, allowing coverage
      to work correctly.
...
.. changelog::
    ...
    .. change::
      ...
      The Session class is now present in dis_sqlalchemy.orm.*.
    ...
    .. change::
      ...
      Main docs divided into "dis_sqlalchemy Core" and
      "dis_sqlalchemy ORM" sections, mapper/relationship docs
...
.. changelog::
    ...
    .. change::
      ...
      dis_sqlalchemy's String types then don't need to
...
.. changelog::
    ...
    .. change::
      ...
      "dis_sqlalchemy.dialects.postgresql" logger name.
    ...
    .. change::
      ...
      The dis_sqlalchemy.orm.shard module now becomes an extension,
      dis_sqlalchemy.ext.horizontal_shard.   The old import
...
.. changelog::
    ...
    .. change::
      ...
      Now uses dis_sqlalchemy.orm.exc.DetachedInstanceError when an
    ...
    .. change::
      ...
      dis_sqlalchemy is not guaranteed to handle the task of unicode
    ...
    .. change::
      ...
      Made dis_sqlalchemy.sql.expressions.Executable part of public
    ...
    .. change::
      ...
      The assert_unicode flag is deprecated.  dis_sqlalchemy will raise
...
.. changelog::
    ...
    .. change::
      ...
      https://docs.dis_sqlalchemy.org/en/latest/changelog/migration_06.html .
    ...
    .. change::
      ...
      example of how to integrate Beaker with dis_sqlalchemy.  See
    ...
    .. change::
       ...
       * Query.query_from_parent() is removed.  Use the
         dis_sqlalchemy.orm.with_parent() function to produce a
       ...
       * the 'echo_uow' flag on Session is removed.  Use
         logging on the "dis_sqlalchemy.orm.unitofwork" name.
       ...
       * ScopedSession.mapper remains deprecated.  See the
         usage recipe at
         https://www.dis_sqlalchemy.org/trac/wiki/UsageRecipes/SessionAwareMapper
       * passing an InstanceState (internal dis_sqlalchemy state object) to
    ...
    .. change::
      ...
      for "dis_sqlalchemy.engine" is enabled overall.  Note that the
    ...
    .. change::
      ...
      a new API called "dis_sqlalchemy.engine.reflection.Inspector".
    ...
    .. change::
      ...
      of many new constructs:
       ...
       linked to a compiler using the dis_sqlalchemy.ext.compiler extension.
    ...
    .. change::
      ...
      called "dis_sqlalchemy.dialects".
      ...
      Connection strings look like:
       ...
       in the following ways:
           ...
           - The "postgres" name can be imported from the old
             ...
             dis_sqlalchemy.databases import postgres" as well as
             "dialects", "from dis_sqlalchemy.dialects.postgres
    ...
    .. change::
      ...
      column names *normalized* to be dis_sqlalchemy case
      ...
      be compatible with further dis_sqlalchemy operations.
    ...
    .. change::
      ...
      lib/dis_sqlalchemy/dialects/type_migration_guidelines.txt .
