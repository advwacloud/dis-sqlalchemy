...
.. changelog::
    ...
    .. change::
        ...
        changes being made for issue #236 dis_sqlalchemy2-stubs when using dis_sqlalchemy
        1.4. These changes are being kept in sync within dis_sqlalchemy 2.0.
        The changes are also backwards compatible with older versions of
        dis_sqlalchemy2-stubs.
...
.. changelog::
    ...
    .. change::
        ...
        dis_sqlalchemy 1.2 for :ticket:`4225`, however the failure modes detected in
    ...
    .. change::
        ...
        first time any dis_sqlalchemy 2.0 deprecation warning would normally be
        emitted, but the ``dis_sqlalchemy_WARN_20`` environment variable is not set.
        ...
        surprise dis_sqlalchemy 2.0 upgrade and also alert that the dis_sqlalchemy 2.0
        ...
        environment variable ``dis_sqlalchemy_SILENCE_UBER_WARNING`` to ``"1"``.
...
.. changelog::
    ...
    .. change::
        ...
        to work for strings as well. dis_sqlalchemy 2.0 may alter this further by
...
.. changelog::
    ...
    .. change::
        ...
        Fixed issue in :mod:`dis_sqlalchemy.ext.mutable` extension where collection
...
.. changelog::
    ...
    .. change::
        ...
        format, causing in-place upgrades of dis_sqlalchemy to no longer be able to
...
.. changelog::
    ...
    .. change::
        ...
        of the ``-W`` parameter and dis_sqlalchemy's test suite will continue to pass.
        ...
        dis_sqlalchemy-specific warnings, or within dis_sqlalchemy-specific sources for
        general Python deprecation warnings, so that non-dis_sqlalchemy deprecation
    ...
    .. change::
        ...
        tests, in the specific case where the dis_sqlalchemy checkout were located in
    ...
    .. change::
        ...
        Adjusted the logging for key dis_sqlalchemy components including
...
.. changelog::
    ...
    .. change::
        ...
        within dis_sqlalchemy event handler functions. The method is analogous to the
...
.. changelog::
    ...
    .. change::
        ...
        fully qualified and locatable. This broke the mypy plugin for dis_sqlalchemy,
...
.. changelog::
    ...
    .. change::
        ...
        "setuptools" in :pep:`632`; dis_sqlalchemy's setup.py has replaced imports
        ...
        59.0.1, ``setup.py`` still has fallback imports to distutils, as dis_sqlalchemy
        1.4 does not have a hard setuptools versioning requirement at this time.
        dis_sqlalchemy 2.0 is expected to use a full :pep:`517` installation layout
    ...
    .. change::
        ...
        dis_sqlalchemy-utils will need to implement this flag. The issue was observed
        as a result of a dis_sqlalchemy-utils datatype that is not currently cacheable.
    ...
    .. change::
        ...
        all internal to dis_sqlalchemy, now participate within the caching system.
    ...
    .. change::
        ...
        tox.ini to be lower than version 8 so that dis_sqlalchemy versions released
...
.. changelog::
    ...
    .. change::
        ...
        mapping object, such as dis_sqlalchemy's own :class:`.RowMapping` or other
    ...
    .. change::
        ...
        Added :class:`.TupleType` to the top level ``dis_sqlalchemy`` import namespace.
...
.. changelog::
    ...
    .. change::
        ...
        pickled, typically when using the ``dis_sqlalchemy.ext.serializer`` extension
    ...
    .. change::
        ...
        Repaired the examples in examples/versioned_rows to use dis_sqlalchemy 1.4 APIs
    ...
    .. change::
        ...
        pattern is clearer, less prone to bugs and simplifies dis_sqlalchemy's
        internals further.
    ...
    .. change::
        ...
        issues within the "expanding IN" feature of dis_sqlalchemy Core that was
    ...
    .. change::
        ...
        Fixed installation issue where the ``dis_sqlalchemy.dialects.mysql`` module
    ...
    .. change::
        ...
        Implemented proper ``__reduce__()`` methods for all dis_sqlalchemy exception
...
.. changelog::
    ...
    .. change::
        ...
        * :attr:`._ConnectionFairy.dbapi_connection` always represents a DBAPI
          ...
          attribute. For asyncio drivers that dis_sqlalchemy adapts into a pep-249
          interface, the returned object will normally be a dis_sqlalchemy adaption
    ...
    .. change::
        ...
        real use in modern dis_sqlalchemy, and will be deprecated in a separate change.
...
.. changelog::
    ...
    .. change::
        ...
        SQL expression form, emitting a deprecation warning when dis_sqlalchemy_WARN_20
        were enabled.
    ...
    .. change::
        ...
        installation and test suite running of dis_sqlalchemy 1.4 on platforms that
        ...
        running ``pip install dis_sqlalchemy[asyncio]`` which will then attempt to
        install ``greenlet``.
    ...
    .. change::
        ...
        Added support for dis_sqlalchemy classes to be defined in user code using
        "generic class" syntax as defined by ``dis_sqlalchemy2-stubs``, e.g.
...
.. changelog::
    ...
    .. change::
        ...
        Fixed regression in :mod:`dis_sqlalchemy.ext.automap` extension such that the
    ...
    .. change::
        ...
        :ticket:`6661`, with dis_sqlalchemy 1.4.19, such that the SELECT statements
...
.. changelog::
    ...
    .. change::
        ...
        of the INSERT thus triggering dis_sqlalchemy's feature of setting IDENTITY
...
.. changelog::
    ...
    .. change::
        ...
        subclasses such as that used by Flask-dis_sqlalchemy don't need to implement
...
.. changelog::
    ...
    .. change::
        ...
        two places makes thing worse, since the types in the dis_sqlalchemy
    ...
    .. change::
        ...
        the standard behavior in dis_sqlalchemy 2.0, where adding the item to a
    ...
    .. change::
        ...
        Fixed regression in the ``dis_sqlalchemy.ext.instrumentation`` extension that
        ...
        :class:`dis_sqlalchemy.ext.instrumentation.InstrumentationManager` class now
...
.. changelog::
    ...
    .. change::
        ...
        A new approach has been applied to the warnings system in dis_sqlalchemy to
        accurately predict the appropriate stack level for each warning
        dynamically. This allows evaluating the source of dis_sqlalchemy-generated
        ...
        arbitrary level within dis_sqlalchemy's own source code.
...
.. changelog::
    ...
    .. change::
        ...
        * Fixed issue in SQL argument coercions system where passing the wrong
          ...
          the object were altogether not a dis_sqlalchemy object, such as a Python
    ...
    .. change::
        ...
        :class:`dis_sqlalchemy.dialects.mysql.BIT` columns, mapping
...
.. changelog::
    ...
    .. change::
        ...
        arbitrary expression constructs which within dis_sqlalchemy's column labeling
...
.. changelog::
    ...
    .. change::
        ...
        what Flask-dis_sqlalchemy is hardcoded as using, so the issue impacts
        Flask-dis_sqlalchemy users. The traversal has been repaired to uniqify on FROM
...
.. changelog::
    ...
    .. change::
        ...
        or for cross-compatibility with older dis_sqlalchemy versions, the
...
.. changelog::
    ...
    .. change::
        ...
        cases emitting the 2.0 deprecation warning when ``dis_sqlalchemy_WARN_20`` is
    ...
    .. change::
        ...
        third party dialects may set this flag to ``False`` to disable dis_sqlalchemy's
...
.. changelog::
    ...
    .. change::
        ...
        attribute of the dis_sqlalchemy exception class raised by the asyncpg DBAPI
...
.. changelog::
    ...
    .. change::
        :tags: bug, mypy
        :tickets: dis_sqlalchemy/dis_sqlalchemy2-stubs/#14
    ...
    .. change::
        ...
        directly on a dialect class in order for dis_sqlalchemy's
    ...
    .. change::
        ...
        Previous versions of dis_sqlalchemy kept aliases in all cases, creating
...
.. changelog::
    ...
    .. change::
        ...
        dis_sqlalchemy, because on this version of Python ``exec "statement"`` and
    ...
    .. change::
        ...
        dis_sqlalchemy asyncio extension.
    ...
    .. change::
        ...
        ``dis_sqlalchemy.engine`` namespace. This name refers to the
...
.. changelog::
    ...
    .. change::
        ...
        Restored top level import for ``dis_sqlalchemy.engine.reflection``. This
    ...
    .. change::
        :tags: bug, mypy
        :tickets: dis_sqlalchemy/dis_sqlalchemy2-stubs/2
...
.. changelog::
    ...
    .. change::
        ...
        a new plugin, which itself depends on new typing stubs for dis_sqlalchemy. The
    ...
    .. change::
        ...
        Added an ``asyncio.Lock()`` within dis_sqlalchemy's emulated DBAPI cursor,
    ...
    .. change::
        ...
        still worthwhile to log as these indicate where dis_sqlalchemy sees the
    ...
    .. change::
        ...
        The ``dis_sqlalchemy.ext.mutable`` extension now tracks the "parents"
...
.. changelog::
    ...
    .. change::
        ...
        is local to dis_sqlalchemy's asyncpg dialect) has been changed from using
...
.. changelog::
    ...
    .. change::
      ...
      in dis_sqlalchemy, to accommodate for the handling of Python ``contextvars``
      ...
      supported by dis_sqlalchemy's greenlet integration.  For greenlet versions prior
    ...
    .. change::
        ...
        dis_sqlalchemy features across Core and ORM which involve this behavior.
        Result set rows since dis_sqlalchemy 1.0 are usually aligned with column
    ...
    .. change::
        ...
        dis_sqlalchemy column or mapped property from the "metadata" dictionary of a
    ...
    .. change::
        ...
        Deprecation warnings are emitted under "dis_sqlalchemy_WARN_20" mode when
    ...
    .. change::
        ...
        Added support for the aiomysql driver when using the asyncio dis_sqlalchemy
        extension.
    ...
    .. change::
        ...
        The dis_sqlalchemy async mode now detects and raises an informative
        error when an non asyncio compatible :term:`DBAPI` is used.
        Using a standard ``DBAPI`` with async dis_sqlalchemy will cause
    ...
    .. change::
        ...
        :class:`_sql.Values` that tells dis_sqlalchemy what the expected type is. This
    ...
    .. change::
        ...
        as ``dis_sqlalchemy.future = true`` or ``dis_sqlalchemy.future = false``.
    ...
    .. change::
        ...
        such as :class:`dis_sqlalchemy.dialects.mysql.INTEGER`, with the "best match"
        generic dis_sqlalchemy type, in this case :class:`_types.Integer`.  Pull
    ...
    .. change::
        ...
        using the ``dis_sqlalchemy.ext.compiles`` extension according to the
...
.. changelog::
    ...
    .. change::
        ...
        dis_sqlalchemy 2.0.  These operations do not work efficiently and load the
    ...
    .. change::
        ...
        The "clause coercion" system, which is dis_sqlalchemy Core's system of receiving
    ...
    .. change::
        ...
        while still allowing for dis_sqlalchemy SQL constructs to be cacheable in their
    ...
    .. change::
        ...
        dis_sqlalchemy 2.0.   An explicit select + subquery, or aliasing of the inner
    ...
    .. change::
        ...
        Dropped support for python 3.4 and 3.5 that has reached EOL. dis_sqlalchemy 1.4
    ...
    .. change::
        ...
        should ensure their requirements are pinned at ``dis_sqlalchemy<1.4``.
    ...
    .. change::
        ...
        dis_sqlalchemy now includes support for Python asyncio within both Core and
        ...
        dis_sqlalchemy's sync-oriented internals such that an asyncio interface that
    ...
    .. change::
        ...
        Removed the ``dis_sqlalchemy.sql.visitors.iterate_depthfirst`` and
        ``dis_sqlalchemy.sql.visitors.traverse_depthfirst`` functions.  These functions
        were unused by any part of dis_sqlalchemy.  The
    ...
    .. change::
        ...
        concept of "bound metadata" is deprecated in dis_sqlalchemy 1.4 and will be
        removed in dis_sqlalchemy 2.0.  The parameter as well as related functions now
    ...
    .. change::
        ...
        case for many major versions of dis_sqlalchemy, these particular boolean
    ...
    .. change::
        ...
        previous dis_sqlalchemy versions in any case.   The "RESTRICT" keyword is
    ...
    .. change::
        ...
        correctly there is essential metadata that is passed from a dis_sqlalchemy
    ...
    .. change::
        ...
        enables forwards compatibility with dis_sqlalchemy 2. is used for forwards
        compatibility with dis_sqlalchemy 2.   This engine features
    ...
    .. change::
        ...
        import spaces under ``dis_sqlalchemy.orm`` and new kinds of mappings.  Support
    ...
    .. change::
        ...
        has not been supported by dis_sqlalchemy for many years and it is not expected
    ...
    .. change::
        ...
        is deprecated and will be removed in dis_sqlalchemy 2.0.  The class-bound
    ...
    .. change::
        ...
        Custom compiler constructs created using the :mod:`dis_sqlalchemy.ext.compiled`
    ...
    .. change::
        ...
        dis_sqlalchemy 2.0.   A 2.0-style warning is emitted when autocommit takes
    ...
    .. change::
       ...
       enum or the set are quoted by dis_sqlalchemy when needed automatically.
    ...
    .. change::
       ...
       :mod:`~dis_sqlalchemy.ext.hybrid` extension. This also removes the function
    ...
    .. change::
        ...
        As part of the dis_sqlalchemy 2.0 migration project, a conceptual change has
    ...
    .. change::
        ...
        In dis_sqlalchemy 2.0, both Core and ORM will return result rows using the same
    ...
    .. change::
        ...
        behavior will be removed in dis_sqlalchemy 2.0 when Python 2 support is also
        removed.
