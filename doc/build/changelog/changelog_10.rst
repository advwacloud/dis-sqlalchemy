...
.. changelog::
    ...
    .. change::
        ...
        turned on unconditionally, which invokes functions on the dis_sqlalchemy
...
.. changelog::
    ...
    .. change::
        ...
        Fixed bug in ``dis_sqlalchemy.ext.baked`` where the unbaking of a
...
.. changelog::
    ...
    .. change::
        ...
        methods for dis_sqlalchemy.util.Properties were
...
.. changelog::
    ...
    .. change::
        ...
        Fixed regression in the :mod:`dis_sqlalchemy.ext.mutable` extension
    ...
    .. change::
        ...
        different name, preventing dis_sqlalchemy's own exception wrapping from
        wrapping the error appropriately.
        The dis_sqlalchemy dialect in use needs to implement a new
...
.. changelog::
    ...
    .. change::
        ...
        Added a new extension suite :mod:`dis_sqlalchemy.ext.baked`.  This
    ...
    .. change::
        ...
        supports CAST on a subset of datatypes.   dis_sqlalchemy has for a long
    ...
    .. change::
        ...
        dis_sqlalchemy has always emitted NULL for a TIMESTAMP column that
        is ``nullable=True``.
    ...
    .. change::
        ...
        into performance of dis_sqlalchemy ORM and Core, as well as the DBAPI,
    ...
    .. change::
        ...
        with dis_sqlalchemy's C-based boolean processor, so MySQL's result-set
    ...
    .. change::
        ...
        The :mod:`dis_sqlalchemy.ext.automap` extension will now set
    ...
    .. change::
        ...
        constructs are now importable from the "from dis_sqlalchemy" namespace,
    ...
    .. change::
        ...
        available as `dis_sqlalchemy-drizzle <https://bitbucket.org/zzzeek/dis_sqlalchemy-drizzle>`_,
        an independent, third party dialect.  The dialect is still based
        almost entirely off of the MySQL dialect present in dis_sqlalchemy.
