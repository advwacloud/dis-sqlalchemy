...
.. changelog::
    ...
    .. change::
        ...
        ``dis_sqlalchemy.ext.compiler`` extension, and did not provide a default
    ...
    .. change::
        ...
        For dis_sqlalchemy 1.3 only, setup.py pins pg8000 to a version lower than
        1.16.6. Version 1.16.6 and above is supported by dis_sqlalchemy 1.4. Pull
    ...
    .. change::
        ...
        dis_sqlalchemy 1.3.11 where use of a SQL expression in RETURNING for an UPDATE
    ...
    .. change::
        ...
        Fixed regression from dis_sqlalchemy 1.3.20 caused by the fix for
...
.. changelog::
    ...
    .. change::
        ...
        the default isolation level as was the case prior to dis_sqlalchemy 1.3.21.
...
.. changelog::
    ...
    .. change::
        ...
        a deprecated behavior that will raise in dis_sqlalchemy 1.4, as an application
    ...
    .. change::
        ...
        :class:`_exc.dis_sqlalchemyError` or a subclass, as occurs with some third
    ...
    .. change::
        ...
        Repaired a function-level import that was not using dis_sqlalchemy's standard
        late-import system within the dis_sqlalchemy.exc module.
    ...
    .. change::
        ...
        Fixed issue where a dis_sqlalchemy connection URI for Azure DW with
...
.. changelog::
    ...
    .. change::
        ...
        enables their support in dis_sqlalchemy when targeting SQLite.
...
.. changelog::
    ...
    .. change::
        ...
        dis_sqlalchemy-firebird dialect will be used if it has been installed,
...
.. changelog::
    ...
    .. change::
        ...
        of dis_sqlalchemy installation by omitting the file.
...
.. changelog::
    ...
    .. change::
        ...
        unconditionally upon making use of that dialect, pulling in dis_sqlalchemy's
    ...
    .. change::
        ...
        ``dis_sqlalchemy.util.compat``, which is needed for the vendored version of
...
.. changelog::
    ...
    .. change::
        ...
        Fixed bug in dis_sqlalchemy.ext.serializer where a unique
...
.. changelog::
    ...
    .. change::
        ...
        be deprecated for dis_sqlalchemy 2.0.
    ...
    .. change::
        ...
        use of a minimal backport of "timezone" in dis_sqlalchemy.util.
...
.. changelog::
    ...
    .. change::
        ...
        dis_sqlalchemy hopes to improve upon the behavior of single entity / tuples in
    ...
    .. change::
        ...
        of these dialects into lowercase-as-case-insensitive for dis_sqlalchemy, to not
    ...
    .. change::
        ...
        parameters should be considered.  The only dis_sqlalchemy backend that expects
    ...
    .. change::
        ...
        to dis_sqlalchemy's unicode decoding converter under Python 2, and to
...
.. changelog::
    ...
    .. change::
        ...
        this value stays at 30 until version dis_sqlalchemy 1.4.  Also repaired issues
...
.. changelog::
    ...
    .. change::
        ...
        that have recently changed this length and the dis_sqlalchemy dialect has
    ...
    .. change::
        ...
        dis_sqlalchemy :class:`.Date`, :class:`.DateTime` or :class:`.Time` datatype is
    ...
    .. change::
        ...
        interfere either with the dis_sqlalchemy compiler's use of string formatting or
...
.. changelog::
    ...
    .. change::
        ...
        which is what dis_sqlalchemy's polymorphic_union function does.   The issue
        ...
        presence,  dis_sqlalchemy will now emit the directive on new connections to
...
.. changelog::
    ...
    .. change::
        ...
        improve upon this situation, dis_sqlalchemy projects for now are using a simple
...
.. changelog::
    ...
    .. change::
        ...
        within the dis_sqlalchemy declarative process.
...
.. changelog::
    ...
    .. change::
       ...
       likely that a direct subclass of a base dis_sqlalchemy type would work as
...
.. changelog::
    ...
    .. change::
       ...
       dis_sqlalchemy since around version 0.2 is now deprecated, along with the
    ...
    .. change::
       ...
       for Python Unicode objects, and dis_sqlalchemy needed to take on the very
       ...
       supported by dis_sqlalchemy support Unicode natively, including on Python 2,
       ...
       dis_sqlalchemy has to deal with Unicode however these are handled automatically;
...
.. changelog::
    ...
    .. change::
        ...
        hit under Python 2, dis_sqlalchemy's very performant (when C extensions
    ...
    .. change::
        ...
        The Python builtin ``dir()`` is now supported for a dis_sqlalchemy "properties"
