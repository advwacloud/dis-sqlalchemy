...
.. changelog::
    ...
    .. change::
       ...
       of the :class:`.dis_sqlalchemyError` base exception class introduced an
       ...
       :class:`.dis_sqlalchemyError` class now passes a bytestring through under
...
.. changelog::
    ...
    .. change::
        ...
        dis_sqlalchemy 1.1 and earlier, cx_Oracle.NUMERIC was passed for all numeric
        ...
        regressive behavior when using dis_sqlalchemy 1.2.  Overall, the setinputsizes
...
.. changelog::
    ...
    .. change::
        ...
        unconditionally when the NVARCHAR2 datatype, in dis_sqlalchemy corresponding
...
.. changelog::
    ...
    .. change::
        ...
        about common error messages.   Selected exceptions within dis_sqlalchemy
...
.. changelog::
    ...
    .. change::
        ...
        SQL Server supports what dis_sqlalchemy calls "native boolean"
    ...
    .. change::
        ...
        in any version of cx_Oracle and in cx_Oracle 6.x, the API which dis_sqlalchemy
...
.. changelog::
    ...
    .. change::
        ...
        this may suggest an issue that should be brought to the dis_sqlalchemy
    ...
    .. change:: 2626
        ...
        :class:`.quoted_name` is also now available from the ``dis_sqlalchemy.sql``
        import space.
    ...
    .. change:: 3303
        ...
        invoked, which is common when using the :mod:`dis_sqlalchemy.ext.mutable`
        extension module.
    ...
    .. change:: 3918
        ...
        Fixed a bug in the ``dis_sqlalchemy.ext.serializer`` extension whereby
