...
.. changelog::
    ...
    .. change::
        ...
        DISABLE_dis_sqlalchemy_CEXT environment variable.  This variable works
    ...
    .. change::
        ...
        Removed stale names from ``dis_sqlalchemy.orm.interfaces.__all__`` and
...
.. changelog::
    ...
    :released: December 8, 2013
     ...
     .. change::
        ...
        a :class:`dis_sqlalchemy.exc.DBAPIError`.  It is now propagated unchanged
...
.. changelog::
    ...
    .. change::
        ...
        e.g.::
            ...
            from dis_sqlalchemy import insert, update, delete
...
.. changelog::
    ...
    .. change::
        ...
        Added :class:`dis_sqlalchemy.types.BIGINT` to the list of type names that can be
    ...
    .. change::
        ...
        use the ``dis_sqlalchemy.testing`` package for external dialects.
...
.. changelog::
    ...
    .. change::
      ...
      Fixes to the ``dis_sqlalchemy.ext.serializer`` extension, including
    ...
    .. change::
      ...
      rather than looking for that dialect in dis_sqlalchemy.dialects.
...
.. changelog::
    ...
    .. change::
      ...
      Fixed bug in :class:`~dis_sqlalchemy.dialects.postgresql.array()` construct whereby using it
...
.. changelog::
    ...
    .. change::
      ...
      dis_sqlalchemy and cx_oracle, however are subject to caveats
    ...
    .. change::
      ...
      The :class:`~dis_sqlalchemy.types.DECIMAL` type now honors the "precision" and
    ...
    .. change::
      ...
      The :mod:`dis_sqlalchemy.ext.mutable` extension now includes the
    ...
    .. change::
      ...
      The "reflect=True" argument to :class:`~dis_sqlalchemy.schema.MetaData` is deprecated.
...
.. changelog::
    ...
    .. change::
      ...
      dis_sqlalchemy 0.8 now targets Python 2.5 and
    ...
    .. change::
      ...
      The "dis_sqlalchemy.exceptions"
      synonym for "dis_sqlalchemy.exc" is removed
      fully.
    ...
    .. change::
      ...
      using the dis_sqlalchemy.ext.mutable extension,
      introduced in 0.7.   The removal of MutableType
      and associated constructs removes a great
      deal of complexity from dis_sqlalchemy's internals.
    ...
    .. change::
      ...
      to dis_sqlalchemy.ext.instrumentation.   This is
    ...
    .. change::
      ...
      time that  dis_sqlalchemy cannot guarantee
    ...
    .. change::
      ...
      * dis_sqlalchemy.orm.shard module
        (use dis_sqlalchemy.ext.horizontal_shard)
    ...
    .. change::
      ...
      part of the dis_sqlalchemy install again.  In addition,
      a new suite of tests is present in the
      new dis_sqlalchemy.testing.suite package.  This is
      an under-development system that hopes to provide
      a universal testing suite for external dialects.
      Dialects which are maintained outside of dis_sqlalchemy
    ...
    .. change::
      ...
      default.   dis_sqlalchemy for many years would
    ...
    .. change::
      ...
      taking advantage of the new dis_sqlalchemy
      ...
      functionality now.
      https://bitbucket.org/zzzeek/dis_sqlalchemy-access
    ...
    .. change::
      ...
      https://bitbucket.org/zzzeek/dis_sqlalchemy-maxdb.
