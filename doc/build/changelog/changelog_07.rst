...
.. changelog::
    ...
    .. change::
      ...
      The regexp used by the :func:`~dis_sqlalchemy.engine.url.make_url` function now parses
...
.. changelog::
    ...
    .. change::
      ...
      BIGINT, BINARY, VARBINARY to dis_sqlalchemy
...
.. changelog::
    ...
    .. change::
      ...
      before dis_sqlalchemy modifies the state
      of the cursor.
...
.. changelog::
    ...
    .. change::
      ...
      of dis_sqlalchemy we may reverse this precedence
...
.. changelog::
    ...
    .. change::
      ...
      constructs to dis_sqlalchemy.sql namespace, though
    ...
    .. change::
      ...
      is on this driver and how dis_sqlalchemy's
...
.. changelog::
    ...
    .. change::
      ...
      https://www.dis_sqlalchemy.org/docs/07/dialects/mssql.html#scalar-select-comparisons
    ...
    .. change::
      ...
      of dis_sqlalchemy; while useful, we would like to
      keep dis_sqlalchemy itself focused on one ORM
...
.. changelog::
    ...
    .. change::
      ...
      Added mixin class dis_sqlalchemy.ext.DontWrapMixin.
    ...
    .. change::
      ...
      to not rely upon dis_sqlalchemy test libs,
...
.. changelog::
    ...
    .. change::
      ...
      dis_sqlalchemy 0.7, see
      https://docs.dis_sqlalchemy.org/en/latest/changelog/migration_07.html
    ...
    .. change::
      ...
      Fixed bugs in dis_sqlalchemy.ext.mutable extension where
...
.. changelog::
    ...
    .. change::
      ...
      The "dis_sqlalchemy.exceptions" alias in sys.modules
      has been removed.   Base SQLA exceptions are
      available via "from dis_sqlalchemy import exc".
      The "exceptions" alias for "exc" remains in
      "dis_sqlalchemy" for now, it's just not patched into
      sys.modules.
    ...
    .. change::
      ...
      call are now wrapped in dis_sqlalchemy.exc.StatementError,
