...
.. changelog::
    ...
    .. change::
      ...
      Added AttributeExtension to dis_sqlalchemy.orm.__all__
    ...
    .. change::
      ...
      https://www.dis_sqlalchemy.org/trac/wiki/UsageRecipes/PreFilteredQuery
      for an example.
...
.. changelog::
    ...
    .. change::
      ...
      dis_sqlalchemy.orm.join and dis_sqlalchemy.orm.outerjoin are now
      added to __all__ in dis_sqlalchemy.orm.*.
...
.. changelog::
    ...
    .. change::
      ...
      ``dis_sqlalchemy.extract()`` is now dialect sensitive and can
...
.. changelog::
    ...
    .. change::
      ...
      dis_sqlalchemy.orm.attributes.  Given an object, attribute name,
    ...
    .. change::
      ...
      dis_sqlalchemy.databases.postgres.
...
.. changelog::
    ...
    .. change::
      ...
      unlikely anyone is doing this, the dis_sqlalchemy author was
    ...
    .. change::
      ...
      dis_sqlalchemy.sql.expression.Function is now a public class.  It
    ...
    .. change::
      ...
      Fixed the import weirdness in dis_sqlalchemy.sql to not export
      __names__.
...
.. changelog::
    ...
    .. change::
      ...
      Added a new extension dis_sqlalchemy.ext.serializer.  Provides
...
.. changelog::
    ...
    .. change::
      ...
      The "entity_name" feature of dis_sqlalchemy mappers has been
...
.. changelog::
    ...
    .. change::
      ...
      association mechanism used by dis_sqlalchemy's native
      instrumentation.
    ...
    .. change::
      ...
      dis_sqlalchemy.exceptions has been renamed to dis_sqlalchemy.exc.  The
    ...
    .. change::
      ...
      ORM-related exceptions are now defined in dis_sqlalchemy.orm.exc.
      ConcurrentModificationError, FlushError, and
      UnmappedColumnError compatibility aliases are installed in
      dis_sqlalchemy.exc during the import of dis_sqlalchemy.orm.

    .. change::
        :tags: 
        :tickets: 

      dis_sqlalchemy.logging has been renamed to dis_sqlalchemy.log.

    .. change::
        :tags: 
        :tickets: 

      The transitional dis_sqlalchemy.log.SADeprecationWarning alias for
      the warning's definition in dis_sqlalchemy.exc has been removed.
