...
.. changelog::
    ...
    .. change::
        ...
        in the ``dis_sqlalchemy.`` and ``dis_sqlalchemy.sql.`` namespace.  Pull request
...
.. changelog::
    ...
    .. change::
        ...
        dis_sqlalchemy 1.2.0b3 and was added retroactively.
...
.. changelog::
    ...
    .. change:: 3950
        ...
        Fixed bug in :mod:`dis_sqlalchemy.ext.mutable` where the
...
.. changelog::
    ...
    .. change:: 3901
        ...
        Fixed bug in new :mod:`dis_sqlalchemy.ext.indexable` extension
...
.. changelog::
    ...
    .. change:: 3878
        ...
        dis_sqlalchemy.sql.expression, due to mis-spelled ``any_`` and ``all_``
        functions.
...
.. changelog::
    ...
    .. change::
        ...
        or non-dis_sqlalchemy objects that are not "executable" are erroneously
...
.. changelog::
    ...
    .. change::
        ...
        dis_sqlalchemy.ext.indexable will intercept IndexError as well
        as KeyError when raising as AttributeError.

    .. change::
        :tags: feature, ext

        Added a "default" parameter to the new dis_sqlalchemy.ext.indexable
        extension.
...
.. changelog::
    ...
    .. change::
        ...
        Made a slight behavioral change in the ``dis_sqlalchemy.ext.compiler``
...
.. changelog::
    ...
    .. change::
        ...
        This is an old parameter no longer relevant to how dis_sqlalchemy
    ...
    .. change::
        ...
        maintaining dis_sqlalchemy's long standing behavior of enabling
