...
.. currentmodule:: dis_sqlalchemy.sql.functions
...
unknown to dis_sqlalchemy, built-in or user defined. The section here only
describes those functions where dis_sqlalchemy already knows what argument and
