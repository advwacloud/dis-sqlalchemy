...
.. glossary::
    ...
    1.x-style
    2.0-style
        These terms are new in dis_sqlalchemy 1.4 and refer to the dis_sqlalchemy 1.4->
        ...
        throughout the 1.x series of dis_sqlalchemy and earlier (e.g. 1.3, 1.2, etc)
    ...
    sentinel
    insert sentinel
        This is a dis_sqlalchemy-specific term that refers to a
        ...
        For typical use cases, the dis_sqlalchemy SQL compiler can automatically
    ...
    insertmanyvalues
        This refers to a dis_sqlalchemy-specific feature which allows INSERT
    ...
    reflection
    reflected
        In dis_sqlalchemy, this term refers to the feature of querying a database's
        schema catalogs in order to load information about existing tables,
        columns, constraints, and other constructs.   dis_sqlalchemy includes
    ...
    declarative
        ...
        In the dis_sqlalchemy ORM, these terms refer to two different styles of
    ...
    selectable
        A term used in dis_sqlalchemy to describe a SQL construct that represents
        a collection of rows.   It's largely similar to the concept of a
        "relation" in :term:`relational algebra`.  In dis_sqlalchemy, objects
        that subclass the :class:`_expression.Selectable` class are considered to be
        usable as "selectables" when using dis_sqlalchemy Core.  The two most
    ...
    annotations
        ...
        The phrase "ORM-annotated" refers to an internal aspect of dis_sqlalchemy,
        ...
        Most of dis_sqlalchemy's documented code examples are formatted with a
        ...
        and is not related to the dis_sqlalchemy concept of "ORM-annotated".
    ...
    plugin-specific
        ...
        dis_sqlalchemy Core which will behave differently when used in an ORM
        context.

        dis_sqlalchemy allows Core constructs such as :class:`_sql.Select` objects
        ...
        at the base of the system that the dis_sqlalchemy ORM makes use of
    ...
    executemany
        ...
        dis_sqlalchemy typically makes use of the ``cursor.executemany()`` method
        ...
        to dis_sqlalchemy Core that the SQL statement and processed parameter sets
        ...
        To overcome this limitation, dis_sqlalchemy as of the 2.0 series implements
        ...
        .. seealso::
            ...
            :ref:`engine_insertmanyvalues` - dis_sqlalchemy feature which allows
    ...
    data marshalling
         ...
         dis_sqlalchemy, we often need to "marshal" data into a format appropriate
         ...
         .. seealso::
            ...
            :ref:`types_typedecorator` - dis_sqlalchemy's :class:`.TypeDecorator`
    ...
    descriptors
        ...
        In dis_sqlalchemy, descriptors are used heavily in order to provide attribute behavior
    ...
    DDL
        ...
        and other permanent objects within a database schema.  dis_sqlalchemy
    ...
    table metadata
        ...
        kind of data.  In dis_sqlalchemy, the term "metadata" typically refers  to
    ...
    version id column
        In dis_sqlalchemy, this refers to the use of a particular table column that
        ...
        "version id column" in different ways, dis_sqlalchemy's ORM includes a particular
        ...
        often referred to as "temporal" data.  In addition to dis_sqlalchemy's
        versioning feature, a few more examples are also present in the
        documentation, see the links below.

        .. seealso::

            :ref:`mapper_version_counter` - dis_sqlalchemy's built-in version id feature.
    ...
    cascade
        A term used in dis_sqlalchemy to describe how an ORM persistence action that
        takes place on a particular object would extend into other objects
        which are directly associated with that object.  In dis_sqlalchemy, these
        ...
        in dis_sqlalchemy was borrowed, for better or worse, from the Hibernate
        ORM.
    ...
    dialect
        In dis_sqlalchemy, the "dialect" is a Python object that represents information
        ...
        :term:`DBAPI`) for that database.   dis_sqlalchemy dialects are subclasses
    ...
    instrumenting
        ...
        made available.  The dis_sqlalchemy :term:`mapping` process,
    ...
    identity key
        ...
        In dis_sqlalchemy, you can view the identity key for an ORM object
    ...
    lazy loading
        ...
        *memoization* that causes it to go out to the database
        ...
        Within dis_sqlalchemy, lazy loading is a key feature of the ORM, and
    ...
    eagerly load
        ...
        the object itself is loaded from the database. In dis_sqlalchemy, the term
    ...
    polymorphic
    polymorphically
        Refers to a function that handles several types at once.  In dis_sqlalchemy,
        ...
        Polymorphic loading in dis_sqlalchemy implies that a one or a
    ...
    method chaining
    generative
        "Method chaining", referred to within dis_sqlalchemy documentation as
        ...
        The two dis_sqlalchemy objects that make the most use of
    ...
    releases
    released
        In the context of dis_sqlalchemy, the term "released"
        refers to the process of ending the usage of a particular
        database connection.    dis_sqlalchemy features the usage
    ...
    pep-249
        ...
        in a Python application to talk to a database.  dis_sqlalchemy's
    ...
    unit of work
        ...
        dis_sqlalchemy's :class:`_orm.Session` implements the unit of work pattern,
        ...
        dis_sqlalchemy, start with the section :ref:`tutorial_orm_data_manipulation`
    ...
    expiring
    Expiring
        In the dis_sqlalchemy ORM, refers to when the data in a :term:`persistent`
    ...
    RETURNING
        ...
        dis_sqlalchemy's :meth:`.UpdateBase.returning` system provides a layer of abstraction
    ...
    one to many
        A style of :func:`~dis_sqlalchemy.orm.relationship` which links
        ...
        single department.  A dis_sqlalchemy mapping might look like::
    ...
    bidirectional relationship
        ...
        distinct :func:`~dis_sqlalchemy.orm.relationship` objects can be
        ...
        the :func:`~dis_sqlalchemy.orm.relationship` function explicitly
        for one side and specifying the ``backref`` keyword to it so that
        the other :func:`~dis_sqlalchemy.orm.relationship` is created
    ...
    many to many
        A style of :func:`dis_sqlalchemy.orm.relationship` which links two tables together
        ...
        In dis_sqlalchemy, the :func:`dis_sqlalchemy.orm.relationship` function
    ...
    relationships
        ...
        The relationship is defined using the dis_sqlalchemy function
        :func:`~dis_sqlalchemy.orm.relationship`.   Once created, dis_sqlalchemy
    ...
    association relationship
        ...
        :func:`dis_sqlalchemy.orm.relationship` construct as in the case
        ...
        A dis_sqlalchemy declarative mapping for the above might look like::
