...
.. seealso::
    ...
    :ref:`examples_adjacencylist` - working example, updated for dis_sqlalchemy 2.0
...
dis_sqlalchemy's joined and subquery eager loading use aliased tables in all cases
...
dis_sqlalchemy needs to be told how many levels deep it should join and/or query;
