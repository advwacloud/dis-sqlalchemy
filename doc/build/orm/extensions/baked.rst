...
.. module:: dis_sqlalchemy.ext.baked
...
.. deprecated:: 1.4  dis_sqlalchemy 1.4 and 2.0 feature an all-new direct query
...
.. deepalchemy::
    ...
    The :mod:`dis_sqlalchemy.ext.baked` extension is **not for beginners**.  Using
    it correctly requires a good high level understanding of how dis_sqlalchemy, the
...
.. topic:: Measure twice, cut once
    ...
    For background on how to profile a dis_sqlalchemy application, please see
...
in the section `BakedQuery <https://bitbucket.org/zzzeek/dis_sqlalchemy/wiki/UsageRecipes/BakedQuery>`_,
...
The :meth:`.ColumnOperators.in_` method in dis_sqlalchemy historically renders
...
As of dis_sqlalchemy 1.3.11, the use of the :meth:`.QueryEvents.before_compile`
...
.. versionchanged:: 1.4 As of dis_sqlalchemy 1.4, the "baked query" system is no
