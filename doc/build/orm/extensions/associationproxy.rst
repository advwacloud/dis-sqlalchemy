...
.. module:: dis_sqlalchemy.ext.associationproxy
...
The association proxy can proxy to dictionary based collections as well.   dis_sqlalchemy
...
`UniqueObject <https://www.dis_sqlalchemy.org/trac/wiki/UsageRecipes/UniqueObject>`_, or
...
to a related object, as in the example mapping below::
    ...
    from dis_sqlalchemy.ext.associationproxy import association_proxy, AssociationProxy
    from dis_sqlalchemy.orm import DeclarativeBase, relationship
    from dis_sqlalchemy.orm.collections import attribute_keyed_dict
    from dis_sqlalchemy.orm.collections import Mapped
