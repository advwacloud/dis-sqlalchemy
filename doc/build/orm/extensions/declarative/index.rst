...
.. currentmodule:: dis_sqlalchemy.ext.declarative
...
.. versionchanged:: 1.4  The vast majority of the Declarative extension is now
   integrated into the dis_sqlalchemy ORM and is importable from the
   ``dis_sqlalchemy.orm`` namespace.  See the documentation at
