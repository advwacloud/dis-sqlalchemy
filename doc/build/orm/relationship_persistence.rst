...
primary key identifiers cannot. The :func:`~dis_sqlalchemy.orm.relationship`
...
:func:`~dis_sqlalchemy.orm.relationship` needs to use two statements.
...
a complete example, including two :class:`_schema.ForeignKey` constructs::
    ...
    from dis_sqlalchemy import Integer, ForeignKey
...
dis_sqlalchemy offers a feature in order to allow propagation of primary key
...
so that dis_sqlalchemy can emit UPDATE statements.
...
"passive" this indicates that dis_sqlalchemy will
