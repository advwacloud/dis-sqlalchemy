...
.. topic:: Concurrent transaction updates
    ...
    the locally updated value.  In this case, the dis_sqlalchemy versioning
    ...
    when the transaction is committed.  dis_sqlalchemy's version_id_col is an alternative
...
this is the condition that dis_sqlalchemy tests, that exactly one row matched our
...
dates and GUIDs.   When using an alternate type or counter scheme, dis_sqlalchemy
