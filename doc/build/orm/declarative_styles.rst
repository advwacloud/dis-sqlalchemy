...
the typical way that mappings are constructed in modern dis_sqlalchemy.   This
...
dis_sqlalchemy declarative mapping with other class instrumentation systems
such as dataclasses_ and attrs_, though note that dis_sqlalchemy 2.0 now features
