...
.. tip:: The examples of :class:`_orm.declared_attr` will attempt to illustrate
   ...
   .. versionadded:: 2.0  As part of :pep:`484` typing support for the
      dis_sqlalchemy ORM, added the :attr:`_orm.declared_attr.directive` to
...
.. versionchanged:: 2.0 For users coming from the 1.4 series of dis_sqlalchemy
...
Relationships created by :func:`~dis_sqlalchemy.orm.relationship` are provided
...
for inheriting subclasses by default::
    ...
    from dis_sqlalchemy.orm import DeclarativeBase
    from dis_sqlalchemy.orm import declared_attr
    from dis_sqlalchemy.orm import has_inherited_table
    from dis_sqlalchemy.orm import Mapped
    from dis_sqlalchemy.orm import mapped_column
