...
and :func:`_sql.delete` constructs (for the latter DML constructs, as of dis_sqlalchemy
...
in a manner roughly similar to that of :attr:`.Select.column_descriptions`::
    ...
    [{'aliased': False,
      'entity': <class 'User'>,
      'expr': <dis_sqlalchemy.orm.attributes.InstrumentedAttribute ...>,
      'name': 'id',
      'type': Integer()}]
...
.. autofunction:: dis_sqlalchemy.orm.aliased

.. autoclass:: dis_sqlalchemy.orm.util.AliasedClass

.. autoclass:: dis_sqlalchemy.orm.util.AliasedInsp

.. autoclass:: dis_sqlalchemy.orm.Bundle
    :members:

.. autofunction:: dis_sqlalchemy.orm.with_loader_criteria

.. autofunction:: dis_sqlalchemy.orm.join

.. autofunction:: dis_sqlalchemy.orm.outerjoin

.. autofunction:: dis_sqlalchemy.orm.with_parent
