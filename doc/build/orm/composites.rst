...
* Map columns directly, then pass to composite
  ...
  :func:`_orm.composite`::
    ...
    from dis_sqlalchemy.orm import mapped_column, composite
...
* Map columns directly, pass attribute names to composite
  ...
  full column constructs::
    ...
    from dis_sqlalchemy.orm import mapped_column, composite, Mapped
...
the same expression that the base "greater than" does::
    ...
    from dis_sqlalchemy.orm import CompositeProperty
