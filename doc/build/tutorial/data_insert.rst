...
.. deepalchemy::
    ...
    should know about this thing that dis_sqlalchemy can do.
    ...
    .. sourcecode:: pycon+sql
        ...
        >>> from dis_sqlalchemy import select, bindparam
        >>> scalar_subq = (
        ...
        ...             {
        ...                 "username": "spongebob",
        ...                 "email_address": "spongebob@dis_sqlalchemy.org",
        ...             },
        ...             {"username": "sandy", "email_address": "sandy@dis_sqlalchemy.org"},
        ...
        [...] [('spongebob', 'spongebob@dis_sqlalchemy.org'), ('sandy', 'sandy@dis_sqlalchemy.org'),
...
.. tip::
    ...
    that are included in dis_sqlalchemy which support RETURNING.  See the section
