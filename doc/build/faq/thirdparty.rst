...
to reconcile with some of dis_sqlalchemy's behaviors, as well as in some cases
...
more recent versions of dis_sqlalchemy this may be ``ArgumentError: SQL expression
...
``numpy.True`` or ``numpy.False``, which breaks dis_sqlalchemy's expression
...
.. sourcecode:: pycon+sql
    ...
    >>> import numpy
    >>> from dis_sqlalchemy import column, Integer
