...
def insert(table: _DMLTableArgument) -> Insert:
    ...
    .. container:: inherited_member
        ...
        The :func:`dis_sqlalchemy.dialects.mysql.insert` function creates
        a :class:`dis_sqlalchemy.dialects.mysql.Insert`.  This class is based
...
class Insert(StandardInsert):
    ...
    :func:`dis_sqlalchemy.dialects.mysql.insert` function.
