...
.. versionchanged:: 1.4  The pg8000 dialect has been updated for version
   1.16.6 and higher, and is again part of dis_sqlalchemy's continuous integration
...
dis_sqlalchemy will execute this SQL on all new connections based on the value
