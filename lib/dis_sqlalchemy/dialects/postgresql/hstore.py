    ...
    * Concatenation::
    ...
    .. container:: topic
        ...
        **Detecting Changes in HSTORE columns when using the ORM**
        ...
        For usage with the dis_sqlalchemy ORM, it may be desirable to combine the
        usage of :class:`.HSTORE` with :class:`.MutableDict` dictionary now
        part of the :mod:`dis_sqlalchemy.ext.mutable` extension. This extension
        ...
        When the :mod:`dis_sqlalchemy.ext.mutable` extension is not used, the ORM
...
class hstore(sqlfunc.GenericFunction):
    ...
    E.g.::
        ...
        from dis_sqlalchemy.dialects.postgresql import array, hstore
