...
def insert(table: _DMLTableArgument) -> Insert:
    ...
    .. container:: inherited_member
        ...
        The :func:`dis_sqlalchemy.dialects.postgresql.insert` function creates
        a :class:`dis_sqlalchemy.dialects.postgresql.Insert`.  This class is based
...
class Insert(StandardInsert):
    ...
    :func:`dis_sqlalchemy.dialects.postgresql.insert` function.
