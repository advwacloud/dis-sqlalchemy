...
of the :mod:`~dis_sqlalchemy.dialects.sqlite.pysqlite` driver, except that the
...
.. warning:: Previous versions of dis_sqlalchemy did not take into consideration
   ...
   previous dis_sqlalchemy version if the encryption options do not match.
