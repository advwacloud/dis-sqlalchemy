...
def insert(table: _DMLTableArgument) -> Insert:
    ...
    .. container:: inherited_member
        ...
        The :func:`dis_sqlalchemy.dialects.sqlite.insert` function creates
        a :class:`dis_sqlalchemy.dialects.sqlite.Insert`.  This class is based
...
class Insert(StandardInsert):
    ...
    :func:`dis_sqlalchemy.dialects.sqlite.insert` function.
