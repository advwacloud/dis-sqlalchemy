...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from dis_sqlalchemy.cyextension.resultproxy import tuplegetter as tuplegetter
...
class Result(_WithKeys, ResultInternal[Row[_TP]]):
    ...
    .. versionadded:: 1.4  The :class:`_engine.Result` object provides a
       completely updated usage model and calling facade for dis_sqlalchemy
       Core and dis_sqlalchemy ORM.   In Core, it forms the basis of the
    ...
    .. note:: In dis_sqlalchemy 1.4 and above, this object is
    ...
    def yield_per(self, num: int) -> Self:
        ...
        .. tip::
            ...
            with :class:`_engine.Connection` is new as of dis_sqlalchemy 1.4.40.
