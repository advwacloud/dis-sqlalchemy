...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    :class:`~dis_sqlalchemy.engine.interfaces.Dialect`, providing a
    ...
    Where above, the :class:`~dis_sqlalchemy.engine.interfaces.Dialect` associated
    ...
    def __init__(self, bind: Union[Engine, Connection]):
        ...
        :param bind: a :class:`~dis_sqlalchemy.engine.Connection`,
    ...
    def from_engine(cls, bind: Engine) -> Inspector:
        ...
        :param bind: a :class:`~dis_sqlalchemy.engine.Connection`
         or :class:`~dis_sqlalchemy.engine.Engine`.

        This method differs from direct a direct constructor call of
        :class:`_reflection.Inspector` in that the
        :class:`~dis_sqlalchemy.engine.interfaces.Dialect` is given a chance to
    ...
    def has_table(
        ...
        .. versionchanged:: 2.0:: :meth:`.Inspector.has_table` now formally
           ...
           * temporary tables of any kind
           ...
           and should be supported by all dis_sqlalchemy-included dialects.
    ...
    def reflect_table(
        ...
        table reflection.  Direct usage is like::
            ...
            from dis_sqlalchemy import create_engine, MetaData, Table
        ...
        :param table: a :class:`~dis_sqlalchemy.schema.Table` instance.
