...
class ReflectedColumn(TypedDict):
    ...
    flag of some kind.   Within dis_sqlalchemy, other kinds of columns may
...
class BindTyping(Enum):
    ...
    the dis_sqlalchemy dialect has the appropriate infrastructure for that
...
class Dialect(EventTarget):
    ...
    dis_sqlalchemy dialects import DBAPI modules using the classmethod
    ...
    True for dis_sqlalchemy internal dialects SQLite, MySQL/MariaDB, PostgreSQL,
    ...
    """A dictionary of TypeEngine classes from dis_sqlalchemy.types mapped
    ...
    """Optional set of argument specifiers for various dis_sqlalchemy
    ...
    it.  dis_sqlalchemy tests that this flag is locally present on each dialect
    ...
    def initialize(self, connection: Connection) -> None:
        ...
        The connection passed here is a dis_sqlalchemy Connection object,
        with full capabilities.

        The initialize() method of the base dialect should be called via
        super().

        .. note:: as of dis_sqlalchemy 1.4, this method is called **before**
    ...
    def has_table(
        ...
        **kw: Any,
        ...
        .. note:: This method is used internally by dis_sqlalchemy, and is
    ...
    def do_set_input_sizes(
        ...
        dis_sqlalchemy type. The order of tuples is in the correct parameter order.
...
class CreateEnginePlugin:
    ...
    * connectivity plugins such as proxies
    ...
    As of version 1.4 of dis_sqlalchemy, arguments should continue to be consumed
...
class ExecutionContext:
    ...
    """if passed to constructor, dis_sqlalchemy.engine.base.Compiled object
      being executed"""
    ...
    def get_out_parameter_values(
        ...
        previous dis_sqlalchemy versions, the values can be the **raw values** from
        ...
        dis_sqlalchemy 1.4 has multiple kinds of result object as part of the 2.0
        transition.
...
class ExceptionContext:
    ...
    dis_sqlalchemy_exception: Optional[StatementError]
    """The :class:`dis_sqlalchemy.exc.StatementError` which wraps the original,
    and will be raised if exception handling is not circumvented by the event.

    May be None, as not all exception types are wrapped by dis_sqlalchemy.
    ...
    dis_sqlalchemy unless a subsequent handler replaces it.
    ...
    dis_sqlalchemy will defer to this flag in order to determine whether or not
