...
def create_engine(url: Union[str, _url.URL], **kwargs: Any) -> Engine:
    ...
    the URL can be an instance of :class:`~dis_sqlalchemy.engine.url.URL`.
    ...
    :param empty_in_strategy:   No longer used; dis_sqlalchemy now uses
    ...
    :param execution_options: Dictionary execution options which will
        ...
        :meth:`~dis_sqlalchemy.engine.Connection.execution_options`

    :param future: Use the 2.0 style :class:`_engine.Engine` and
        :class:`_engine.Connection` API.

        As of dis_sqlalchemy 2.0, this parameter is present for backwards
    ...
    :param implicit_returning=True:  Legacy parameter that may only be set
        to True. In dis_sqlalchemy 2.0, this parameter does nothing. In order to
    ...
    :param logging_name:  String identifier which will be used within
        ...
        "dis_sqlalchemy.engine" logger. Defaults to a hexstring of the
        object's id.
    ...
    :param max_identifier_length: integer; override the max_identifier_length
        ...
        dis_sqlalchemy's dialect has not been adjusted, the value may be passed
        here.
    ...
    :param max_overflow=10: the number of connections to allow in
        ...
        to five. this is only used with :class:`~dis_sqlalchemy.pool.QueuePool`.
    ...
    :param pool=None: an already-constructed instance of
        :class:`~dis_sqlalchemy.pool.Pool`, such as a
        :class:`~dis_sqlalchemy.pool.QueuePool` instance. If non-None, this
        pool will be used directly as the underlying connection pool
        for the engine, bypassing whatever connection parameters are
        present in the URL argument. For information on constructing
        connection pools manually, see :ref:`pooling_toplevel`.

    :param poolclass=None: a :class:`~dis_sqlalchemy.pool.Pool`
    ...
    :param pool_logging_name:  String identifier which will be used within
       the "name" field of logging records generated within the
       "dis_sqlalchemy.pool" logger. Defaults to a hexstring of the object's
       id.
    ...
    :param pool_size=5: the number of connections to keep open
        ...
        :class:`~dis_sqlalchemy.pool.QueuePool` as
        well as :class:`~dis_sqlalchemy.pool.SingletonThreadPool`.  With
        :class:`~dis_sqlalchemy.pool.QueuePool`, a ``pool_size`` setting
        of 0 indicates no limit; to disable pooling, set ``poolclass`` to
        :class:`~dis_sqlalchemy.pool.NullPool` instead.
    ...
    :param pool_timeout=30: number of seconds to wait before giving
        ...
        with :class:`~dis_sqlalchemy.pool.QueuePool`. This can be a float but is
...
def engine_from_config(
    configuration: Dict[str, Any], prefix: str = "dis_sqlalchemy.", **kwargs: Any
) -> Engine:
    ...
    ``dis_sqlalchemy.url``, ``dis_sqlalchemy.echo``, etc.  The 'prefix' argument
    indicates the prefix to be searched for.  Each matching key (after the
    prefix is stripped) is treated as though it were the corresponding keyword
    argument to a :func:`_sa.create_engine` call.

    The only required key is (assuming the default prefix) ``dis_sqlalchemy.url``,
