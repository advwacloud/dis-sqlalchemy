...
class CursorResultMetaData(ResultMetaData):
    ...
    def __init__(
        ...
        # update keymap with "translated" names.  In dis_sqlalchemy this is a
    ...
    def _merge_cursor_description(
        ...
        dis_sqlalchemy for all cases up through the 0.9 series.   Positional
...
class CursorResult(Result[_T]):
    ...
    .. versionchanged:: 1.4  The :class:`.CursorResult``
       ...
       dis_sqlalchemy Core and dis_sqlalchemy ORM.
    ...
    def inserted_primary_key_rows(self):
        ...
        .. note:: As indicated below, in current dis_sqlalchemy versions this
        ...
        * **When using all other dialects / backends that don't yet support
        ...
        Future releases of dis_sqlalchemy will further generalize the
    ...
    def inserted_primary_key(self):
        ...
        Raises :class:`~dis_sqlalchemy.exc.InvalidRequestError` if the executed
        statement is not a compiled expression construct
    ...
    def splice_horizontally(self, other):
        ...
        .. tip::  This method is for the benefit of the dis_sqlalchemy ORM and is
