# dis_sqlalchemy/engine/events.py
...
class ConnectionEvents(event.Events[ConnectionEventsTarget]):
    ...
    class or instance, such as an :class:`_engine.Engine`, e.g.::
        ...
        from dis_sqlalchemy import event, create_engine
...
class DialectEvents(event.Events[Dialect]):
    ...
    def _accept_with(
        ...
        if isinstance(target, type):
            ...
            raise exc.InvalidRequestError(
                "The handle_error() event hook as of dis_sqlalchemy 2.0 is "
    ...
    def handle_error(
        ...
        within dis_sqlalchemy's statement invocation process, including
        ...
        * exception re-writing
        ...
        can be called on this cursor; dis_sqlalchemy will attempt to close
        this cursor subsequent to this hook being invoked.

        As of dis_sqlalchemy 2.0, the "pre_ping" handler enabled using the
        ...
        the dis_sqlalchemy-constructed exception into one that is user
        ...
        When a custom exception is raised or returned, dis_sqlalchemy raises
        this new exception as-is, it is not wrapped by any dis_sqlalchemy
        object.  If the exception is not a subclass of
        :class:`dis_sqlalchemy.exc.StatementError`,
