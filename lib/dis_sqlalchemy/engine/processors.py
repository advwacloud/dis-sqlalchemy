# dis_sqlalchemy/processors.py
# Copyright (C) 2010-2023 the dis_sqlalchemy authors and contributors
# <see AUTHORS file>
...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from dis_sqlalchemy.cyextension.processors import (
        DecimalResultProcessor,
    )
    from dis_sqlalchemy.cyextension.processors import (  # noqa: F401
        int_to_boolean as int_to_boolean,
    )
    from dis_sqlalchemy.cyextension.processors import (  # noqa: F401,E501
