...
"""Default implementations of per-dialect dis_sqlalchemy.engine classes.
    ...
    def _supports_statement_cache(self):
        ...
        if ssc is None:
            util.warn(
                ...
                "for dis_sqlalchemy 1.4 caching support.   Alternatively, this "
...
class DefaultExecutionContext(ExecutionContext):
    ...
    def _prepare_set_input_sizes(
        ...
        Prior to dis_sqlalchemy 2.0, the setinputsizes() approach was also used
