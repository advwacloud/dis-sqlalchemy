...
if TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from dis_sqlalchemy.cyextension.resultproxy import BaseRow as BaseRow
...
class Row(BaseRow, Sequence[Any], Generic[_TP]):
    ...
    typically associated in the 1.x series of dis_sqlalchemy with the
    :class:`_engine.CursorResult` object, however is also used by the ORM for
    tuple-like results as of dis_sqlalchemy 1.4.
