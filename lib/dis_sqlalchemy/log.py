# dis_sqlalchemy/log.py
# Copyright (C) 2006-2023 the dis_sqlalchemy authors and contributors
# <see AUTHORS file>
...
'dis_sqlalchemy'.  For class-level logging, the class name is appended.
...
# logging being enabled for 'dis_sqlalchemy'.
rootlogger = logging.getLogger("dis_sqlalchemy")
