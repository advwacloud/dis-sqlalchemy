...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from dis_sqlalchemy.cyextension.util import (  # noqa: F401,E501
...
class Visitable:
    ...
    def _generate_compiler_dispatch(cls) -> None:
        ...
        if "_compiler_dispatch" in cls.__dict__:
            ...
            # dis_sqlalchemy.ext.compiles overrides it.
...
class InternalTraversal(Enum):
    ...
    * :meth:`.HasCacheKey._gen_cache_key`
    ...
    The operator is a function from the :mod:`dis_sqlalchemy.sql.operators`
    module.
...
class HasTraverseInternals:
    ...
    @util.preload_module("dis_sqlalchemy.sql.traversals")
    def get_children(
