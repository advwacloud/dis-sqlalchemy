...
class TypeEngine(Visitable, Generic[_T]):
    ...
    For an overview of the dis_sqlalchemy typing system, see
    :ref:`types_toplevel`.
    ...
    class Comparator(
        ...
        @util.preload_module("dis_sqlalchemy.sql.default_comparator")
        def operate(
    ...
    def compare_against_backend(
        ...
        This function is currently not implemented for dis_sqlalchemy
        ...
        A future release of dis_sqlalchemy will potentially implement this method
    ...
    def _resolve_for_python_type(
        ...
        Python standard library ``enum.Enum`` classes to the dis_sqlalchemy
    ...
    def _generic_type_affinity(
        ...
        for t in self.__class__.__mro__:
            if (
                t.__module__
                in (
                    "dis_sqlalchemy.sql.sqltypes",
                    "dis_sqlalchemy.sql.type_api",
                )
    ...
    def as_generic(self, allow_nulltype: bool = False) -> TypeEngine[_T]:
        ...
        >>> from dis_sqlalchemy.dialects.mysql import NVARCHAR
...
class ExternalType(TypeEngineMixin):
    ...
    of dis_sqlalchemy within either end-user application code or within
    external extensions to dis_sqlalchemy.
    ...
    cannot itself be used as a key in a "cache dictionary" such as dis_sqlalchemy's
    statement cache, since Python dictionaries aren't hashable::
        ...
        >>> # dis_sqlalchemy statement cache
    ...
    def _static_cache_key(
        ...
        if cache_ok is None:
            ...
            util.warn(
                ...
                "performance degradations in comparison to prior dis_sqlalchemy "
...
class UserDefinedType(
    ...
    more appropriate::
      ...
      import dis_sqlalchemy.types as types
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    ...
    This method is preferred to direct subclassing of dis_sqlalchemy's
    ...
    For most dis_sqlalchemy types, this includes ``NoneType``, as well as
    ``bool``.
    ...
    def result_processor(
        ...
        :param dialect: Dialect instance in use.
        :param coltype: A dis_sqlalchemy data type
    ...
    def coerce_compared_value(
        ...
        object which does not yet have a dis_sqlalchemy type assigned::

            expr = table.c.somecolumn + 35

        Where above, if ``somecolumn`` uses this type, this method will
        be called with the value ``operator.add``
        and ``35``.  The return value is whatever dis_sqlalchemy type should
...
class Variant(TypeDecorator[_T]):
    ...
    def __init__(self, *arg: Any, **kw: Any):
        raise NotImplementedError(
            "Variant is no longer used in dis_sqlalchemy; this is a "
