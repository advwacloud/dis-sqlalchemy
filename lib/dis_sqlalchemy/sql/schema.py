...
All entities are subclasses of :class:`~dis_sqlalchemy.schema.SchemaItem`, and as
defined in this module they are intended to be agnostic of any vendor-specific
constructs.

A collection of entities are grouped into a unit called
:class:`~dis_sqlalchemy.schema.MetaData`. MetaData serves as a logical grouping of
schema elements, and can also be associated with an actual database connection
such that operations involving the contained elements can contact the database
as needed.

Two of the elements here also build upon their "syntactic" counterparts, which
are defined in :class:`~dis_sqlalchemy.sql.expression.`, specifically
:class:`~dis_sqlalchemy.schema.Table` and :class:`~dis_sqlalchemy.schema.Column`.
...
class Table(
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param implicit_returning: True by default - indicates that
            ...
            In modern dis_sqlalchemy there is generally no reason to alter this
        ...
        :param quote: Force quoting of this table's name on or off, corresponding
            ...
            .. note:: setting this flag to ``False`` will not provide
              ...
              fashion.  Case insensitive names are specified in dis_sqlalchemy only
    ...
    def append_column(
        ...
        :param replace_existing: When ``True``, allows replacing existing
            ...
            version of dis_sqlalchemy will instead rise a warning.
    ...
    def append_constraint(self, constraint: Union[Index, Constraint]) -> None:
        ...
        be used.  dis_sqlalchemy also provides the
    ...
    def __init__(
        ...
        **dialect_kwargs: Any,
        ...
        :param name: The name of this column as represented in the database.
          ...
          usage within the :mod:`~dis_sqlalchemy.ext.declarative` extension.

        :param type\_: The column's type, indicated using an instance which
          subclasses :class:`~dis_sqlalchemy.types.TypeEngine`.  If no arguments
        ...
        :param autoincrement: Set up "auto increment" semantics for an
          ...
          * DDL issued for the column, if the column does not already include
            ...
            primary dis_sqlalchemy dialects includes:
        ...
        :param onupdate: A scalar, Python callable, or
            :class:`~dis_sqlalchemy.sql.expression.ClauseElement` representing a
        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            or :func:`~dis_sqlalchemy.sql.expression.text` construct representing
            ...
            A :func:`~dis_sqlalchemy.sql.expression.text` expression will be
            ...
            valid dis_sqlalchemy expressions or constructs::

                from dis_sqlalchemy import create_engine
                from dis_sqlalchemy import Table, Column, MetaData, ARRAY, Text
            ...
            will be available to dis_sqlalchemy for post-fetch after inserts. This
        ...
        :param server_onupdate: A :class:`.FetchedValue` instance
            ...
            indicates to dis_sqlalchemy that a newly generated value will be
        ...
        :param quote: Force quoting of this column's name on or off,
             ...
             reserved word which is not known by the dis_sqlalchemy dialect.
...
class ColumnElementColumnDefault(ColumnDefault):
    ...
    @util.memoized_property
    @util.preload_module("dis_sqlalchemy.sql.sqltypes")
...
class Sequence(HasSchemaAttr, IdentityOptions, DefaultGenerator):
    ...
    a construct that can be "executed" by a dis_sqlalchemy :class:`_engine.Engine`
    ...
    @util.preload_module("dis_sqlalchemy.sql.functions")
...
class MetaData(HasSchemaAttr):
    ...
    @util.preload_module("dis_sqlalchemy.engine.reflection")
    def reflect(
        self,
