...
def between(
    ...
    E.g.::
        ...
        from dis_sqlalchemy import between
...
def outparam(
    ...
    :class:`~dis_sqlalchemy.engine.CursorResult` object via its ``out_parameters``
...
def bindparam(
    ...
    In dis_sqlalchemy, the :func:`.bindparam` construct has
    ...
    dis_sqlalchemy's Core expression system makes wide use of
    ...
    :param quote:
      ...
      currently known as a dis_sqlalchemy reserved word; this currently
    ...
    :param literal_execute:
      ...
      with a special "POSTCOMPILE" token, and the dis_sqlalchemy compiler will
...
def case(
    *whens: Union[
    ...
    as in::
        ...
        from dis_sqlalchemy import case, literal_column
...
def try_cast(
    ...
    In dis_sqlalchemy, this construct is supported **only** by the SQL Server
    ...
    .. tip:: As :func:`_sql.try_cast` originates from the SQL Server dialect,
       it's importable both from ``dis_sqlalchemy.`` as well as from
       ``dis_sqlalchemy.dialects.mssql``.
    ...
    E.g.::
        ...
        from dis_sqlalchemy import select, try_cast, Numeric
...
def distinct(expr: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    as in::
        ...
        from dis_sqlalchemy import distinct, func
...
def funcfilter(
    ...
    E.g.::
        ...
        from dis_sqlalchemy import funcfilter
...
def nulls_first(column: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    should be handled when they are encountered during ordering::
        ...
        from dis_sqlalchemy import desc, nulls_first
...
def nulls_last(column: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    should be handled when they are encountered during ordering::
        ...
        from dis_sqlalchemy import desc, nulls_last
...
def text(text: str) -> TextClause:
    ...
    dis_sqlalchemy type constructs to play a role when executing
...
def tuple_(
    *clauses: _ColumnExpressionArgument[Any],
    ...
    .. warning::
        ...
        :class:`~dis_sqlalchemy.exc.DBAPIError` when such an expression is
        invoked.
