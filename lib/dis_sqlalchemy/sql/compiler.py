...
class SQLCompiler(Compiled):
    ...
    def insert_single_values_expr(self) -> Optional[str]:
        ...
        .. versionchanged:: 2.0 This collection is no longer used by
           dis_sqlalchemy's built-in dialects, in favor of the currently
    ...
    @util.preload_module("dis_sqlalchemy.engine.cursor")
    ...
    @util.memoized_property
    @util.preload_module("dis_sqlalchemy.engine.result")
    ...
    def visit_select(
        ...
        **kwargs,
        ...
        assert select_wraps_for is None, (
            "dis_sqlalchemy 1.4 requires use of "
...
class IdentifierPreparer:
    ...
    @util.preload_module("dis_sqlalchemy.sql.naming")
