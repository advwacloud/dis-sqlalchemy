# sql/ddl.py
# Copyright (C) 2009-2023 the dis_sqlalchemy authors and contributors
# <see AUTHORS file>
#
...
class ExecutableDDLElement(roles.DDLRole, Executable, BaseDDLElement):
    ...
    :class:`.ExecutableDDLElement` integrates closely with dis_sqlalchemy events,
...
class DDL(ExecutableDDLElement):
    ...
    Examples::
      ...
      from dis_sqlalchemy import event, DDL
...
class CreateColumn(BaseDDLElement):
    ...
    compiler extension documented in :ref:`dis_sqlalchemy.ext.compiler_toplevel`
    ...
    as follows::
        ...
        from dis_sqlalchemy import Table, Metadata, Column, Integer, String
        from dis_sqlalchemy import schema
...
class SchemaDropper(InvokeDropDDLBase):
    ...
    def visit_table(
        ...
        with self.with_ddl_events(
            ...
            # (see https://docs.dis_sqlalchemy.org/en/
