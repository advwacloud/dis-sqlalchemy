...
class UpdateBase(
    ...
    def return_defaults(
        ...
        *cols: _DMLColumnArgument,
        ...
        4. An INSERT statement invoked with executemany() is supported if the
           ...
           feature which is now supported by most dis_sqlalchemy-included backends.
    ...
    def returning(
        ...
        **__kw: Any,
        ...
        natively support returning values (i.e. cx_oracle), dis_sqlalchemy will
...
class Update(DMLWhereBase, ValuesBase):
    ...
    def ordered_values(self, *args: Tuple[_DMLColumnArgument, Any]) -> Self:
        ...
        .. versionchanged:: 1.4 The :meth:`_expression.Update.ordered_values`
           ...
           parameter, which will be removed in dis_sqlalchemy 2.0.
