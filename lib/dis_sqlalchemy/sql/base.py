...
@util.preload_module("dis_sqlalchemy.dialects")
...
class DialectKWArgs:
    ...
    def argument_for(cls, dialect_name, argument_name, default):
        ...
        :param dialect_name: name of a dialect.  The dialect must be
         ...
         within dis_sqlalchemy include this collection, however for third party
        ...
        for k in kwargs:
            ...
            try:
                ...
                util.warn(
                    ...
                    "locate any dis_sqlalchemy dialect named %r"
                    % (k, dialect_name)
                )
...
class Executable(roles.StatementRole):
    ...
    def execution_options(self, **kw: Any) -> Self:
        ...
        **execution options never affect the compiled SQL of a query, only
        ...
        by dis_sqlalchemy Core or ORM, as well as arbitrary keyword arguments not
        defined by dis_sqlalchemy, which means the methods and/or parameter
        ...
        dis_sqlalchemy, most apply to specific classes of objects and not others.
...
class ColumnCollection(Generic[_COLKEY, _COL_co]):
    ...
    maintains dis_sqlalchemy's older behavior of not allowing duplicates; this
