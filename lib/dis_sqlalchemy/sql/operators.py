...
class Operators:
    ...
    :meth:`~dis_sqlalchemy.sql.operators.Operators.operate` and
    :meth:`~dis_sqlalchemy.sql.operators.Operators.reverse_operate`, as well as
    :meth:`~dis_sqlalchemy.sql.operators.Operators.__and__`,
    :meth:`~dis_sqlalchemy.sql.operators.Operators.__or__`,
    :meth:`~dis_sqlalchemy.sql.operators.Operators.__invert__`.
    ...
    def op(
        ...
        :param precedence: precedence which the database is expected to apply
         ...
         .. seealso::
            ...
            of how the dis_sqlalchemy SQL compiler renders parenthesis
...
class custom_op(OperatorType, Generic[_T]):
    ...
    to represent the "factorial" operation::
        ...
        from dis_sqlalchemy.sql import UnaryExpression
...
class ColumnOperators(Operators):
    ...
    a dis_sqlalchemy-specific operator function from
    :mod:`dis_sqlalchemy.expression.operators`.   For example
    the ``__eq__`` function::
    ...
    def __lshift__(self, other: Any) -> ColumnOperators:
        ...
        Not used by dis_sqlalchemy core, this is provided
