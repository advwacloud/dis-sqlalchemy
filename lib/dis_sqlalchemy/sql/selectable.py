...
class Selectable(ReturnsRows):
    ...
    @util.deprecated(
        ...
        "functionality is available via the dis_sqlalchemy.sql.visitors module.",
    )
    @util.preload_module("dis_sqlalchemy.sql.util")
...
class NamedFromClause(FromClause):
    ...
    def table_valued(self) -> TableValuedColumn[Any]:
        ...
        .. sourcecode:: pycon+sql
            ...
            >>> from dis_sqlalchemy import select, column, func, table
...
class SelectLabelStyle(Enum):
    ...
    .. sourcecode:: pycon+sql
        ...
        >>> from dis_sqlalchemy import table, column, select, true, LABEL_STYLE_NONE
    ...
    .. sourcecode:: pycon+sql
        ...
        >>> from dis_sqlalchemy import table, column, select, true, LABEL_STYLE_TABLENAME_PLUS_COL
        >>> table1 = table("table1", column("columna"), column("columnb"))
        >>> table2 = table("table2", column("columna"), column("columnc"))
    ...
    :data:`_sql.LABEL_STYLE_TABLENAME_PLUS_COL` is dis_sqlalchemy's legacy
    ...
    .. sourcecode:: pycon+sql
        ...
        >>> from dis_sqlalchemy import table, column, select, true, LABEL_STYLE_DISAMBIGUATE_ONLY
        >>> table1 = table("table1", column("columna"), column("columnb"))
        >>> table2 = table("table2", column("columna"), column("columnc"))
...
class Join(roles.DMLTableRole, FromClause):
    ...
    def _join_condition(
        ...
        *,
        ...
        See dis_sqlalchemy.sql.util.join_condition() for full docs.
...
class HasCTE(roles.HasCTERole, SelectsRows):
    ...
    def add_cte(self, *ctes: CTE, nest_here: bool = False) -> Self:
        ...
        E.g.::
            ...
            from dis_sqlalchemy import table, column, select
    ...
    def cte(
        ...
        dis_sqlalchemy detects :class:`_expression.CTE` objects, which are treated
        ...
        Example 1, non recursive::
            ...
            from dis_sqlalchemy import (Table, Column, String, Integer,
        ...
        Example 3, an upsert using UPDATE and INSERT with CTEs::
            ...
            from dis_sqlalchemy import (MetaData, Table, Column, Integer,
        ...
        Example 4, Nesting CTE (dis_sqlalchemy 1.4.24 and above)::
        ...
        as follows (dis_sqlalchemy 2.0 and above)::
        ...
        Example 5, Non-Linear CTE (dis_sqlalchemy 1.4.28 and above)::
...
class TableClause(roles.DMLTableRole, Immutable, NamedFromClause):
    ...
    @util.preload_module("dis_sqlalchemy.sql.dml")
...
class GenerativeSelect(SelectBase, Generative):
    ...
    def set_label_style(self, style: SelectLabelStyle) -> Self:
        ...
        In modern dis_sqlalchemy, there is not generally a need to change the
...
class _MemoizedSelectEntities(
    ...
    In previous dis_sqlalchemy versions, this wasn't needed because these
...
class AnnotatedFromClause(Annotated):
    ...
    def c(self) -> ReadOnlyColumnCollection[str, KeyedColumnElement[Any]]:
        ...
        dis_sqlalchemy versions this can be expensive for statements constructed
        with ORM aliases.   So for #8796 dis_sqlalchemy 2.0 we instead proxy
