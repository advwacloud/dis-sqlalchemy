...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    def scalar_table_valued(self, name, type_=None):
        ...
        .. sourcecode:: pycon+sql
            ...
            >>> from dis_sqlalchemy import func, select
    ...
    def columns(self):
        ...
        .. sourcecode:: pycon+sql
            ...
            >>> from dis_sqlalchemy import column, select, func
    ...
    def alias(self, name=None, joins_implicitly=False):
        ...
        .. sourcecode:: pycon+sql
            ...
            >>> from dis_sqlalchemy import func, select, column
...
class _FunctionGenerator:
    ...
    dis_sqlalchemy, it will be rendered exactly as is. For common SQL functions
    which dis_sqlalchemy is aware of, the name may be interpreted as a *generic
    ...
    dis_sqlalchemy can be made aware of the return type of functions to enable
    type-specific lexical and result-based behavior. For example, to ensure
    that a string-based function returns a Unicode value and is similarly
    treated as a string in expressions, specify
    :class:`~dis_sqlalchemy.types.Unicode` as the type:
    ...
    but are not exactly the same as "functions" from a dis_sqlalchemy
    perspective.
...
class GenericFunction(Function[_T]):
    ...
    on or off for the name, use the :class:`.dis_sqlalchemy.sql.quoted_name`
    construct::
...
class now(GenericFunction[datetime.datetime]):
    ...
    dis_sqlalchemy dialects will usually render this particular function
...
class concat(GenericFunction[str]):
    ...
    String concatenation in dis_sqlalchemy is more commonly available using the
