...
of dis_sqlalchemy objects, both within the Core as well as the
ORM.

The :func:`_sa.inspect` function is the entry point to dis_sqlalchemy's
...
getting" functions in dis_sqlalchemy, such as
...
tools which build on top of dis_sqlalchemy configurations to be constructed
...
def inspect(subject: Any, raiseerr: bool = True) -> Any:
    ...
    :param raiseerr: When ``True``, if the given subject
     does not
     correspond to a known dis_sqlalchemy inspected type,
     :class:`dis_sqlalchemy.exc.NoInspectionAvailable`
