...
if TYPE_CHECKING:
    from dis_sqlalchemy import dialects as _dialects
    from dis_sqlalchemy import orm as _orm
    from dis_sqlalchemy.engine import cursor as _engine_cursor
    from dis_sqlalchemy.engine import default as _engine_default
    from dis_sqlalchemy.engine import reflection as _engine_reflection
    from dis_sqlalchemy.engine import result as _engine_result
    from dis_sqlalchemy.engine import url as _engine_url
    from dis_sqlalchemy.orm import attributes as _orm_attributes
    from dis_sqlalchemy.orm import base as _orm_base
    from dis_sqlalchemy.orm import clsregistry as _orm_clsregistry
    from dis_sqlalchemy.orm import decl_api as _orm_decl_api
    from dis_sqlalchemy.orm import decl_base as _orm_decl_base
    from dis_sqlalchemy.orm import dependency as _orm_dependency
    from dis_sqlalchemy.orm import descriptor_props as _orm_descriptor_props
    from dis_sqlalchemy.orm import mapperlib as _orm_mapper
    from dis_sqlalchemy.orm import properties as _orm_properties
    from dis_sqlalchemy.orm import relationships as _orm_relationships
    from dis_sqlalchemy.orm import session as _orm_session
    from dis_sqlalchemy.orm import state as _orm_state
    from dis_sqlalchemy.orm import strategies as _orm_strategies
    from dis_sqlalchemy.orm import strategy_options as _orm_strategy_options
    from dis_sqlalchemy.orm import util as _orm_util
    from dis_sqlalchemy.sql import default_comparator as _sql_default_comparator
    from dis_sqlalchemy.sql import dml as _sql_dml
    from dis_sqlalchemy.sql import elements as _sql_elements
    from dis_sqlalchemy.sql import functions as _sql_functions
    from dis_sqlalchemy.sql import naming as _sql_naming
    from dis_sqlalchemy.sql import schema as _sql_schema
    from dis_sqlalchemy.sql import selectable as _sql_selectable
    from dis_sqlalchemy.sql import sqltypes as _sql_sqltypes
    from dis_sqlalchemy.sql import traversals as _sql_traversals
    from dis_sqlalchemy.sql import util as _sql_util
...
class _ModuleRegistry:
    ...
    in the form `<package>_<module>`, omitting ``dis_sqlalchemy`` from the package
    name. Example: ``dis_sqlalchemy.sql.util`` becomes ``preloaded.sql_util``.
    """

    def __init__(self, prefix="dis_sqlalchemy."):
