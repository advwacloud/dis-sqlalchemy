...
:class:`~dis_sqlalchemy.sql.expression.ClauseElement` subclasses and one or
...
Above, ``MyColumn`` extends :class:`~dis_sqlalchemy.sql.expression.ColumnClause`,
...
invoked for the dialect in use::
    ...
    from dis_sqlalchemy.schema import DDLElement
...
:class:`~dis_sqlalchemy.engine.interfaces.Compiled` object in use. This object
...
:class:`~dis_sqlalchemy.sql.compiler.SQLCompiler` and
:class:`~dis_sqlalchemy.sql.compiler.DDLCompiler` both include a ``process()``
method which can be used for compilation of embedded attributes::

    from dis_sqlalchemy.sql.expression import Executable, ClauseElement
...
an endless loop.   Such as, to add "prefix" to all insert statements::
    ...
    from dis_sqlalchemy.sql.expression import Insert
...
A big part of using the compiler extension is subclassing dis_sqlalchemy
...
* :class:`~dis_sqlalchemy.sql.expression.ClauseElement` - This is the root
  expression class. Any SQL expression can be derived from this base, and is
  probably the best choice for longer constructs such as specialized INSERT
  statements.

* :class:`~dis_sqlalchemy.sql.expression.ColumnElement` - The root of all
  "column-like" elements. Anything that you'd place in the "columns" clause of
  a SELECT statement (as well as order by and group by) can derive from this -
  the object will automatically have Python "comparison" behavior.

  :class:`~dis_sqlalchemy.sql.expression.ColumnElement` classes want to have a
...
* :class:`~dis_sqlalchemy.sql.functions.FunctionElement` - This is a hybrid of a
...
* :class:`~dis_sqlalchemy.sql.expression.Executable` - This is a mixin which
...
datatype of the object::
    ...
    CacheKey(
        ...
        'name', 'some_name',
        'type', (<class 'dis_sqlalchemy.sql.sqltypes.String'>,
...
For PostgreSQL and Microsoft SQL Server::
    ...
    from dis_sqlalchemy.ext.compiler import compiles
    from dis_sqlalchemy.types import DateTime
...
accommodates two arguments::
    ...
    from dis_sqlalchemy.sql import expression, case
    from dis_sqlalchemy.ext.compiler import compiles
...
Example usage::
    ...
    from dis_sqlalchemy import select, union_all
