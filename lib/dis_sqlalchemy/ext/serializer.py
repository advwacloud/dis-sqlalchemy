...
"""Serializer/Deserializer objects for usage with dis_sqlalchemy query structures,
...
Any dis_sqlalchemy query structure, either based on dis_sqlalchemy.sql.*
or dis_sqlalchemy.orm.* can be used.  The mappers, Tables, Columns, Session
...
Usage is nearly the same as that of the standard Python pickle module::
    ...
    from dis_sqlalchemy.ext.serializer import loads, dumps
