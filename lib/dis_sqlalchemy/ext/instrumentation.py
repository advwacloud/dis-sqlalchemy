...
The :mod:`dis_sqlalchemy.ext.instrumentation` package provides for alternate
...
This attribute is consulted by dis_sqlalchemy instrumentation
resolution, once the :mod:`dis_sqlalchemy.ext.instrumentation` module
...
dis_sqlalchemy.ext.instrumentation.INSTRUMENTATION_MANAGER.
