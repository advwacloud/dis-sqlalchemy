...
# Copyright (C) 2020-2023 the dis_sqlalchemy authors and contributors
# <see AUTHORS file>
#
...
def async_engine_from_config(
    ...
    in dis_sqlalchemy Core, except that the requested dialect must be an
...
class AsyncConnection(
    ...
    async def run_sync(
        ...
        This method allows traditional synchronous dis_sqlalchemy functions to
        ...
        E.g.::
            ...
            def do_something_with_core(conn: Connection, arg1: int, arg2: str) -> str:
                ...
                :param conn: a Core dis_sqlalchemy Connection, used synchronously
        ...
        .. note::
            ...
            callable should only call into dis_sqlalchemy's asyncio database
...
class AsyncEngine(ProxyComparable[Engine], AsyncConnectable):
    ...
    @property
    def name(self) -> Any:
        r"""String name of the :class:`~dis_sqlalchemy.engine.interfaces.Dialect`
    ...
    @property
    def driver(self) -> Any:
        r"""Driver name of the :class:`~dis_sqlalchemy.engine.interfaces.Dialect`
        in use by this :class:`Engine`.
