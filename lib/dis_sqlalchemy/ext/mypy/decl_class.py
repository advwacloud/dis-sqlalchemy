...
) -> Optional[List[util.dis_sqlalchemyAttribute]]:
...
def _scan_declarative_assignment_stmt(
    ...
    if node.is_inferred or node.type is None:
        ...
        if (
            ...
            # print(node.type)
            # dis_sqlalchemy.orm.attributes.Mapped[<python type>]
