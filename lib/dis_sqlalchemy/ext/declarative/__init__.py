...
@util.moved_20(
    ...
    ":func:`dis_sqlalchemy.orm.declarative_base`."
)
...
@util.moved_20(
    ...
    ":func:`dis_sqlalchemy.orm.as_declarative`"
)
...
@util.moved_20(
    ...
    ":func:`dis_sqlalchemy.orm.has_inherited_table`."
)
...
@util.moved_20(
    ...
    ":func:`dis_sqlalchemy.orm.synonym_for`"
)
