...
class collection:
    ...
    def internally_instrumented(fn):
        ...
        :func:`.collection_adapter` in one of the basic dis_sqlalchemy
        interface methods, or to prevent an automatic ABC method
        decoration from wrapping your implementation::

            # normally an 'extend' method on a list-like class would be
            # automatically intercepted and re-implemented in terms of
            # dis_sqlalchemy events and append().  your implementation will
    ...
    def adds(arg):
        ...
        argument indicates which method argument holds the dis_sqlalchemy-relevant
    ...
    def replaces(arg):
        ...
        holds the dis_sqlalchemy-relevant value to be added, and return value, if
