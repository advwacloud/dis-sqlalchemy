...
class _SessionClassMethods:
    ...
    @classmethod
    @util.preload_module("dis_sqlalchemy.orm.util")
    def identity_key(
        cls,
...
class Session(_SessionClassMethods, EventTarget):
    ...
    def __init__(
        ...
        *,
        ...
        :param \class_: Specify an alternate class other than
           ``dis_sqlalchemy.orm.session.Session`` which should be used by the
        ...
        :param enable_baked_queries: legacy; defaults to ``True``.
           ...
           by the :mod:`dis_sqlalchemy.ext.baked` extension to determine if
           "baked queries" should be cached, as is the normal operation
           of this extension.  When set to ``False``, caching as used by
           this particular extension is disabled.

           .. versionchanged:: 1.4 The ``dis_sqlalchemy.ext.baked`` extension is
              legacy and is not used by any of dis_sqlalchemy's internals. This
        ...
        :param join_transaction_mode: Describes the transactional behavior to
          ...
          * ``"control_fully"`` - the :class:`_orm.Session` will take
            ...
            .. tip:: This mode of use is equivalent to how dis_sqlalchemy 1.4 would
    ...
    def prepare(self) -> None:
        ...
        :exc:`~dis_sqlalchemy.exc.InvalidRequestError`.

        Only root transactions of two phase sessions can be prepared. If the
        current transaction is not such, an
        :exc:`~dis_sqlalchemy.exc.InvalidRequestError` is raised.
    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        6. No bind can be found, :exc:`~dis_sqlalchemy.exc.UnboundExecutionError`
           is raised.
    ...
    def query(
        ...
        dis_sqlalchemy 2.0; the :func:`_sql.select` construct is now used
    ...
    def bulk_save_objects(
        ...
        .. legacy::
            ...
            dis_sqlalchemy.   For modern bulk INSERT and UPDATE, see
            ...
            :ref:`tutorial_orm_data_manipulation`.  dis_sqlalchemy 2.0
    ...
    def is_modified(
        ...
        * Scalar attributes may not have recorded the previously set
          ...
          ultimately no net change against its database value. dis_sqlalchemy in
