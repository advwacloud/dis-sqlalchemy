...
class ColumnProperty(
    ...
    @util.preload_module("dis_sqlalchemy.orm.state", "dis_sqlalchemy.orm.strategies")
...
class MappedColumn(
    ...
    @util.preload_module("dis_sqlalchemy.orm.decl_base")
            ...
            for check_type in checks:
                ...
                if isinstance(our_type, TypeEngine) or (
                    ...
                    raise sa_exc.ArgumentError(
                        ...
                        "attribute Mapped annotation is the dis_sqlalchemy type "
                        f"{our_type}. Expected a Python type instead"
                    )
                else:
                    raise sa_exc.ArgumentError(
                        "Could not locate dis_sqlalchemy Core type for Python "
