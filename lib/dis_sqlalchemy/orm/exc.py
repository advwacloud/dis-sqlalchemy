...
class StaleDataError(sa_exc.dis_sqlalchemyError):
...
class FlushError(sa_exc.dis_sqlalchemyError):
...
class ObjectDereferencedError(sa_exc.dis_sqlalchemyError):
...
class DetachedInstanceError(sa_exc.dis_sqlalchemyError):
...
class UnmappedInstanceError(UnmappedError):
    ...
    @util.preload_module("dis_sqlalchemy.orm.base")
        ...
        if not msg:
            try:
                ...
                msg = (
                    ...
                    "is created before dis_sqlalchemy.orm.mapper(%s) "
