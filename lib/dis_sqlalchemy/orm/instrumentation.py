...
"""Defines dis_sqlalchemy's system of class instrumentation.
...
or global basis using the :mod:`dis_sqlalchemy.ext.instrumentation`
module, which provides the means to build and specify
alternate instrumentation forms.

.. versionchanged: 0.8
   The instrumentation extension system was moved out of the
   ORM and into the external :mod:`dis_sqlalchemy.ext.instrumentation`
   package.  When that package is imported, it installs
   itself within dis_sqlalchemy.orm so that its more comprehensive
    ...
    def __init__(self, class_):
        ...
        if "__del__" in class_.__dict__:
            util.warn(
                ...
                "as dis_sqlalchemy instrumentation often creates "
...
# this attribute is replaced by dis_sqlalchemy.ext.instrumentation
# when imported.
_instrumentation_factory = InstrumentationFactory()

# these attributes are replaced by dis_sqlalchemy.ext.instrumentation
