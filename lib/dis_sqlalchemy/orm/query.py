...
class Query(
    ...
    .. legacy:: The ORM :class:`.Query` object is a legacy construct
       as of dis_sqlalchemy 2.0.   See the notes at the top of
    ...
    def scalar_subquery(self) -> ScalarSelect[Any]:
        ...
        Analogous to
        :meth:`dis_sqlalchemy.sql.expression.SelectBase.scalar_subquery`.
    ...
    def enable_eagerloads(self, value: bool) -> Self:
        ...
        eager joins regardless of :func:`~dis_sqlalchemy.orm.joinedload`,
        :func:`~dis_sqlalchemy.orm.subqueryload` options
    ...
    def yield_per(self, count: int) -> Self:
        ...
        As of dis_sqlalchemy 1.4, the :meth:`_orm.Query.yield_per` method is
    ...
    def get(self, ident: _PKIdentityArgument) -> Optional[Any]:
        ...
        If not, :class:`~dis_sqlalchemy.orm.exc.ObjectDeletedError` is raised.
    ...
    def autoflush(self, setting: bool) -> Self:
        ...
        As of dis_sqlalchemy 1.4, the :meth:`_orm.Query.autoflush` method
    ...
    def populate_existing(self) -> Self:
        ...
        As of dis_sqlalchemy 1.4, the :meth:`_orm.Query.populate_existing` method
    ...
    @util.preload_module("dis_sqlalchemy.orm.relationships")
    def with_parent(
        self,
        instance: object,
    ...
    def execution_options(self, **kwargs: Any) -> Self:
        ...
        automatically if the :meth:`~dis_sqlalchemy.orm.query.Query.yield_per()`
    ...
    def with_for_update(
        ...
        *,
        ...
        .. warning::
            ...
            dis_sqlalchemy and may not work with certain queries on various
            database backends.  When ``with_for_update`` is successfully used
            with a query that involves :func:`_orm.joinedload`, dis_sqlalchemy will
    ...
    def union_all(self, *q: Query[Any]) -> Self:
        ...
        Works the same way as :meth:`~dis_sqlalchemy.orm.query.Query.union`. See
    ...
    def join(
        ...
        **Joins to a Target with an ON Clause**
        ...
        aliases set up using the :func:`~dis_sqlalchemy.orm.aliased` function::
    ...
    def distinct(self, *expr: _ColumnExpressionArgument[Any]) -> Self:
        ...
        .. note::
            ...
            .. deprecated:: 2.0  This logic is deprecated and will be removed
               in dis_sqlalchemy 2.0.     See :ref:`migration_20_query_distinct`
    ...
    def one_or_none(self) -> Optional[_T]:
        ...
        no rows.  Raises ``dis_sqlalchemy.orm.exc.MultipleResultsFound``
    ...
    def one(self) -> _T:
        ...
        Raises ``dis_sqlalchemy.orm.exc.NoResultFound`` if the query selects
        no rows.  Raises ``dis_sqlalchemy.orm.exc.MultipleResultsFound``
        if multiple object identities are returned, or if multiple
        rows are returned for a query that returns only scalar values
        as opposed to full identity-mapped entities.
    ...
    def count(self) -> int:
        ...
        other aggregate functions, use :attr:`~dis_sqlalchemy.sql.expression.func`
    ...
    def update(
        ...
        :param values: a dictionary with attributes names, or alternatively
         ...
         :paramref:`~dis_sqlalchemy.sql.expression.update.preserve_parameter_order`
