...
def polymorphic_union(
    ...
    :param aliasname: name of the :func:`~dis_sqlalchemy.sql.expression.alias()`
     construct generated.
...
class _TraceAdaptRole(enum.Enum):
    ...
    dis_sqlalchemy 2.0 has greatly scaled back ORM features which relied heavily on
...
class AliasedClass(
    ...
    The ORM equivalent of a :func:`~dis_sqlalchemy.sql.expression.alias`
    construct, this object mimics the mapped class using a
    ``__getattr__`` scheme and maintains a reference to a
    real :class:`~dis_sqlalchemy.sql.expression.Alias` object.
    ...
    def _get_from_serialized(
        ...
        # dis_sqlalchemy.ext.serializer extension
