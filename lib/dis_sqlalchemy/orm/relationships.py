...
class RelationshipProperty(
    ...
    @util.preload_module("dis_sqlalchemy.orm.mapper")
    ...
    @util.memoized_property
    @util.preload_module("dis_sqlalchemy.orm.clsregistry")
    ...
    @util.preload_module("dis_sqlalchemy.orm.dependency")
            ...
            if to_ not in self._track_overlapping_sync_targets:
                ...
                for pr, fr_ in prop_to_from.items():
                    if (
                        ...
                        # dis_sqlalchemy as a general means of suppressing the
