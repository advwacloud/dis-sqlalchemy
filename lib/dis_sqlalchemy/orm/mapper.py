...
Defines the :class:`~dis_sqlalchemy.orm.mapper.Mapper` class, the central
configurational unit which associates a class with a database table.

This is a semi-private module; the main configurational API of the ORM is
available in :class:`~dis_sqlalchemy.orm.`.
...
class Mapper(
    ...
    def __init__(
        ...
        :param eager_defaults: if True, the ORM will immediately fetch the
          ...
          ``INSERT`` statements where dis_sqlalchemy can take advantage of
        ...
        :param version_id_col: A :class:`_schema.Column`
           ...
           version id, a
           :class:`~dis_sqlalchemy.orm.exc.StaleDataError` exception is
           thrown.
    ...
    def _configure_class_instrumentation(self):
        ...
        if manager is None or not manager.registry:
            raise sa_exc.InvalidRequestError(
                ...
                " Please use the dis_sqlalchemy.orm.registry.map_imperatively() "
    ...
    @util.preload_module("dis_sqlalchemy.orm.descriptor_props")
    ...
    def identity_key_from_instance(self, instance: _O) -> _IdentityKeyType[_O]:
        ...
        :class:`~dis_sqlalchemy.orm.exc.ObjectDeletedError` is raised.
    ...
    @util.preload_module("dis_sqlalchemy.orm.strategy_options")
...
def configure_mappers():
    ...
    .. versionchanged:: 1.4
        ...
        As of dis_sqlalchemy 1.4.0b2, this function works on a
...
@util.preload_module("dis_sqlalchemy.orm.decl_api")
