...
# use of dis_sqlalchemy.util.typing.DescriptorReference to avoid mis-interpretation
# by typing tools
...
class PropComparator(SQLORMOperations[_T], Generic[_T], ColumnOperators):
    ...
    dis_sqlalchemy allows for operators to
    ...
    the appropriate subclass of :class:`.PropComparator` should be used::
        ...
        from dis_sqlalchemy.orm.properties import \
                                ColumnProperty,\
                                Composite,\
                                Relationship
        ...
        from dis_sqlalchemy.orm import column_property, relationship, composite
        from dis_sqlalchemy import Column, String
