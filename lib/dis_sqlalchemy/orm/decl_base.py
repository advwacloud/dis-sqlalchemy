...
class MappedClassProtocol(Protocol[_O]):
    """A protocol representing a dis_sqlalchemy mapped class.
...
class _ClassScanMapperConfig(_MapperConfig):
    ...
    """if the class has dis_sqlalchemy native dataclass parameters, where
    ...
    def __init__(
        ...
        if (not cld or dca) and sdk:
            raise exc.InvalidRequestError(
                "dis_sqlalchemy mapped dataclasses can't consume mapping "
    ...
    def _cls_attr_override_checker(
        ...
        attribute, taking dis_sqlalchemy-enabled dataclass fields into account.
    ...
    def _cls_attr_resolver(
        ...
        which we want to consider for mapping, adjusting for dis_sqlalchemy fields
        ...
        if warn_for_non_dc_attrs:
            for (
                ...
                util.warn_deprecated(
                    ...
                    f"dis_sqlalchemy 2.1.  When declaring dis_sqlalchemy Declarative "
    ...
    def _apply_dataclasses_to_any_class(
        ...
        try:
            ...
            # process; for mixins and __abstract__ superclasses, dis_sqlalchemy
    ...
    def _warn_for_decl_attributes(
        ...
        if isinstance(c, expression.ColumnElement):
            util.warn(
                ...
                "be a non-schema dis_sqlalchemy expression "
                ...
                if isinstance(value, _DCAttributeOptions):
                    if (
                        ...
                        raise exc.ArgumentError(
                            ...
                            "dis_sqlalchemy native dataclass configuration."
                        )
