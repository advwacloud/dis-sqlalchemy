...
See the dis_sqlalchemy object relational tutorial and mapper configuration
...
def __go(lcls: Any) -> None:
    _sa_util.preloaded.import_prefix("dis_sqlalchemy.orm")
    _sa_util.preloaded.import_prefix("dis_sqlalchemy.ext")
