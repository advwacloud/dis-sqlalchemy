...
def mapped_column(
    ...
    **kw: Any,
    ...
    Declarative mappings in dis_sqlalchemy 1.x style.
...
def column_property(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    :param deferred:
        ...
        :func:`~dis_sqlalchemy.orm.deferred`.
...
def relationship(
    ...
    **kw: Any,
    ...
    :param backref:
      ...
      new :pep:`484` typing features introduced in dis_sqlalchemy 2.0 which
    ...
    :param lazy='select': specifies
      ...
      * ``raise`` - lazy loading is disallowed; accessing
        ...
        loading, will raise an :exc:`~dis_sqlalchemy.exc.InvalidRequestError`.
      ...
      * ``raise_on_sql`` - lazy loading that emits SQL is disallowed;
        ...
        :exc:`~dis_sqlalchemy.exc.InvalidRequestError`, **if the lazy load
    ...
    :param passive_updates=True:
      ...
      dependent rows.  When False, the dis_sqlalchemy
      :func:`_orm.relationship`
      construct will attempt to emit its own UPDATE statements to
      modify related targets.  However note that dis_sqlalchemy **cannot**
    ...
    :param omit_join:
      ...
      added in dis_sqlalchemy 1.3; or leave as ``None`` to leave automatic
...
def synonym(
    ...
    *,
    ...
    :param map_column: **For classical mappings and mappings against
      ...
      :func:`dis_sqlalchemy.ext.declarative.synonym_for` helper.  However,
...
def create_session(
    ...
    :param bind: optional, a single Connectable to use for all
      ...
      :class:`~dis_sqlalchemy.orm.session.Session`.

    :param \*\*kwargs: optional, passed through to the
      :class:`.Session` constructor.

    :returns: an :class:`~dis_sqlalchemy.orm.session.Session` instance
    ...
    Usage::
      ...
      >>> from dis_sqlalchemy.orm import create_session
...
def _mapper_fn(*arg: Any, **kw: Any) -> NoReturn:
    ...
    This symbol remains in dis_sqlalchemy 2.0 to suit the deprecated use case
    ...
    raise InvalidRequestError(
        "The 'dis_sqlalchemy.orm.mapper()' function is removed as of "
        "dis_sqlalchemy 2.0.  Use the "
        "'dis_sqlalchemy.orm.registry.map_imperatively()` "
        "method of the ``dis_sqlalchemy.orm.registry`` class to perform "
        "classical mapping."
    )
...
def clear_mappers() -> None:
    ...
    extremely rare use case - the only such use case is in fact dis_sqlalchemy's
...
def with_polymorphic(
    ...
    :param selectable: a table or subquery that will
        ...
        inheritance, since dis_sqlalchemy currently cannot generate UNIONs
...
def join(
    ...
    In modern dis_sqlalchemy the above join can be written more
    succinctly as::
