...
libraries, mainly external dis_sqlalchemy and Alembic dialects, to make use
of the same test environment and standard suites available to
dis_sqlalchemy/Alembic themselves without the need to ship/install a separate
package outside of dis_sqlalchemy.
...
if to_bootstrap == "pytest":
    ...
    sys.modules["sqla_plugin_base"].bootstrapped_as_dis_sqlalchemy = True
