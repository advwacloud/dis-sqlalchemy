...
class SuiteRequirements(Requirements):
    ...
    def table_value_constructor(self):
        ...
        dis_sqlalchemy generates this with the :func:`_sql.values` function.
    ...
    def get_isolation_level_values(self):
        ...
        method added in dis_sqlalchemy 2.0.
    ...
    def numeric_received_as_decimal_untyped(self):
        ...
        or ints, including when no dis_sqlalchemy-side typing information is
    ...
    @property
    def dis_sqlalchemy2_stubs(self):
        def check(config):
            try:
                __import__("dis_sqlalchemy-stubs.ext.mypy")
            except ImportError:
                return False
            else:
                return True
    ...
    @property
    def no_dis_sqlalchemy2_stubs(self):
        def check(config):
            try:
                __import__("dis_sqlalchemy-stubs.ext.mypy")
            except ImportError:
