...
def expect_warnings(*messages, **kw):
    ...
    dis_sqlalchemy.util.warn and dis_sqlalchemy.util.warn_limited.   Otherwise
...
def uses_deprecated(*messages):
    ...
    verbiage emitted by the dis_sqlalchemy.util.deprecated decorator.
...
def _expect_warnings_sqla_only(
    ...
    """dis_sqlalchemy internal use only _expect_warnings().
