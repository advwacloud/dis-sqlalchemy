...
installs dis_sqlalchemy's testing plugin into the local environment.
...
os.environ["dis_sqlalchemy_WARN_20"] = "true"

collect_ignore_glob = []

# this requires that dis_sqlalchemy.testing was not already
