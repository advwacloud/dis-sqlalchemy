...
class ImmutableDict(Case):
    @staticmethod
    def python():
        from dis_sqlalchemy.util._py_collections import immutabledict

        return immutabledict

    @staticmethod
    def c():
        from dis_sqlalchemy.cimmutabledict import immutabledict

        return immutabledict

    @staticmethod
    def cython():
        from dis_sqlalchemy.cyextension.immutabledict import immutabledict
...
class Processor(Case):
    ...
    @staticmethod
    def c():
        from dis_sqlalchemy import cprocessors as mod
    ...
    @staticmethod
    def cython():
        from dis_sqlalchemy.cyextension import processors as mod
...
class DistillParam(Case):
    ...
    @staticmethod
    def python():
        from dis_sqlalchemy.engine import _py_util

        return _py_util

    @staticmethod
    def cython():
        from dis_sqlalchemy.cyextension import util as mod
...
class IdentitySet(Case):
    ...
    @staticmethod
    def python():
        from dis_sqlalchemy.util._py_collections import IdentitySet

        return IdentitySet

    @staticmethod
    def cython():
        from dis_sqlalchemy.cyextension import collections
...
class OrderedSet(IdentitySet):
    ...
    @staticmethod
    def python():
        from dis_sqlalchemy.util._py_collections import OrderedSet
...
class TupleGetter(Case):
    ...
    @staticmethod
    def python():
        from dis_sqlalchemy.engine._py_row import tuplegetter

        return tuplegetter

    @staticmethod
    def c():
        from dis_sqlalchemy import cresultproxy

        return cresultproxy.tuplegetter

    @staticmethod
    def cython():
        from dis_sqlalchemy.cyextension import resultproxy
...
class BaseRow(Case):
    @staticmethod
    def python():
        from dis_sqlalchemy.engine._py_row import BaseRow

        return BaseRow

    @staticmethod
    def c():
        from dis_sqlalchemy.cresultproxy import BaseRow
...
class CacheAnonMap(Case):
    @staticmethod
    def python():
        from dis_sqlalchemy.sql._py_util import cache_anon_map

        return cache_anon_map

    @staticmethod
    def cython():
        from dis_sqlalchemy.cyextension.util import cache_anon_map
...
class PrefixAnonMap(Case):
    @staticmethod
    def python():
        from dis_sqlalchemy.sql._py_util import prefix_anon_map

        return prefix_anon_map

    @staticmethod
    def cython():
        from dis_sqlalchemy.cyextension.util import prefix_anon_map
    ...
    def init_objects(self):
        from dis_sqlalchemy.sql.elements import _anonymous_label
