...
# EXPECTED_RE_TYPE: dis_sqlalchemy..*AsyncConnection\*?
...
# EXPECTED_RE_TYPE: dis_sqlalchemy..*AsyncSession\*?
reveal_type(async_session)


single_stmt = select(User.name).where(User.name == "foo")

# EXPECTED_RE_TYPE: dis_sqlalchemy..*Select\*?\[Tuple\[builtins.str\*?\]\]
reveal_type(single_stmt)

multi_stmt = select(User.id, User.name).where(User.name == "foo")

# EXPECTED_RE_TYPE: dis_sqlalchemy..*Select\*?\[Tuple\[builtins.int\*?, builtins.str\*?\]\]
...
def t_entity_varieties() -> None:
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy..*.Result\[Tuple\[builtins.int\*?, typed_results.User\*?, builtins.str\*?\]\]
    reveal_type(r1)
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy.*Result\[Tuple\[typed_results.User\*?, typed_results.User\*?\]\]
    reveal_type(r2)
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy.*Select\*?\[Tuple\[builtins.int\*?, builtins.int\*?, typed_results.User\*?, typed_results.User\*?\]\]
    reveal_type(s3)
    ...
    # NOTEXPECTED_RE_TYPE: dis_sqlalchemy..*Select\*?\[Tuple\[typed_results.User\*?, typed_results.User\*?, typed_results.User\*?\]\]

    # dis_sqlalchemy.sql._gen_overloads.Select[Tuple[typed_results.User, typed_results.User, typed_results.User]]
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy..*Select\*?\[Tuple\[builtins.int\*?, builtins.int\*?\, builtins.str\*?]\]
    reveal_type(s5)
...
def t_result_scalar_accessors() -> None:
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy..*ScalarResult\[builtins.str.*?\]
    reveal_type(r4)
...
def t_connection_execute_multi_row_t() -> None:
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy.*CursorResult\[Tuple\[builtins.int\*?, builtins.str\*?\]\]
    reveal_type(result)
    row = result.one()

    # EXPECTED_RE_TYPE: dis_sqlalchemy.*Row\[Tuple\[builtins.int\*?, builtins.str\*?\]\]
    reveal_type(row)
...
def t_connection_execute_multi() -> None:
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy.*TupleResult\[Tuple\[builtins.int\*?, builtins.str\*?\]\]
    reveal_type(result)
    row = result.one()
...
def t_connection_execute_single() -> None:
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy.*TupleResult\[Tuple\[builtins.str\*?\]\]
    reveal_type(result)
    row = result.one()
...
async def t_async_connection_stream_multi() -> None:
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy.*AsyncTupleResult\[Tuple\[builtins.int\*?, builtins.str\*?\]\]
    reveal_type(result)
...
async def t_async_connection_stream_single() -> None:
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy.*AsyncTupleResult\[Tuple\[builtins.str\*?\]\]
    reveal_type(result)
    row = await result.one()
...
async def t_async_connection_stream_scalars() -> None:
    ...
    # EXPECTED_RE_TYPE: dis_sqlalchemy.*AsyncScalarResult\*?\[builtins.str\*?\]
    reveal_type(result)
