"""A performance profiling suite for a variety of dis_sqlalchemy use cases.
...
to greatest, inversely based on amount of functionality provided by dis_sqlalchemy,
...
individual tests::
    ...
    test_core : Individual INSERT/COMMIT pairs using Core. (1000 iterations); total fn calls 186109
       ...
       ncalls  tottime  percall  cumtime  percall filename:lineno(function)
         ...
         1000    0.021    0.000    0.074    0.000 /Users/classic/dev/dis_sqlalchemy/lib/dis_sqlalchemy/sql/compiler.py:1950(_get_colparams)
         1000    0.015    0.000    0.034    0.000 /Users/classic/dev/dis_sqlalchemy/lib/dis_sqlalchemy/engine/default.py:503(_init_compiled)
...
we can create a file ``test_loads.py``, with the following content::
    ...
    from dis_sqlalchemy import Integer, Column, create_engine, ForeignKey
    from dis_sqlalchemy.orm import relationship, joinedload, subqueryload, Session
