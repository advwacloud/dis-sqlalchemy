...
which allow the usage of Dogpile caching with dis_sqlalchemy.
...
The rest of what's here are standard dis_sqlalchemy and
...
class FromCache(UserDefinedOption):
    ...
    # this is not needed as of dis_sqlalchemy 1.4.28;
